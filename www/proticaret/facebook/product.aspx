<%@ Page Language="vb" AutoEventWireup="false" Inherits="ASPNetPortal.facebookproductPage" ValidateRequest="false" EnableEventValidation="false" SmartNavigation="False" Codebehind="product.aspx.vb" %>
...
//if (window == window.top) {window.parent.location='/default.aspx' }
</script> 
<div id="container">
