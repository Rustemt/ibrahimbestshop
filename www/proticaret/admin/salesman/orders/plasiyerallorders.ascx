<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="plasiyerallorders.ascx.vb" Inherits="ASPNetPortal.plasiyerallorders" %>
<%@ Register Assembly="AjaxControls" Namespace="AjaxControls" TagPrefix="asp" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register TagPrefix="ew" Namespace="eWorld.UI" Assembly="eWorld.UI" %>
<div class="pagePlasiyerOrders">
                ...
                <div class="tab">
                    <div class="colGroup">
                        <asp:Panel ID="filterpanel" runat="server">
                            ...
                            <div class="col col2">
                                <label><%=GetGlobalResourceObject("admin", "CustomerRepresentativeName")%></label>
                                <asp:TextBox ID="txtplasiyername" runat="server"></asp:TextBox>
                                <asp:DropDownList ID="ddlfilterplasiyer" runat="server">
    ...
    <div class="dataTable">
        <asp:DataGrid ID="Datagrid1" runat="server" GridLines="None" AllowPaging="True" PageSize="20" AutoGenerateColumns="False" ShowFooter="True" AllowSorting="True" HeaderStyle-CssClass="title">
            <Columns>
                ...
                <asp:TemplateColumn SortExpression="OrderId" HeaderText="<%$ Resources:admin,OrderNoCode %>" Visible="false">
                    <ItemTemplate>
                        <%#Eval("OrderId") & "/" & Eval("OrderCode")%>
                        <asp:Label runat="server" ID="lblOrderId" Text='<%#Eval("OrderId")%>' Visible="false"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn HeaderText="<%$ Resources:admin,OrderNoCode %>">
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink3" runat="Server" CssClass="btnLink fancyContent" NavigateUrl='<%# String.Format("{0}/admin/ecommerce/orders/EditOrder.aspx?IND=" & DataBinder.Eval(Container.DataItem, "OrderId") & "&MID=" & 0, BaseUrl)%> '><%#Eval("OrderId") & "/" & Eval("OrderCode")%></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateColumn>
                <asp:BoundColumn DataField="PlasiyerName" SortExpression="PlasiyerName" HeaderText="<%$ Resources:admin,CustomerRepresentativeName %>"></asp:BoundColumn>
                <asp:BoundColumn DataField="FullName" SortExpression="FullName" HeaderText="<%$ Resources:admin,MemberName %>"></asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="ShipDate" SortExpression="ShipDate" HeaderText="<%$ Resources:admin,ShipDate %>" DataFormatString="{0:d}" Visible="false"></asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="ShippingName" SortExpression="ShippingName" HeaderText="<%$ Resources:admin,DeliveryName %>" Visible="false"></asp:BoundColumn>
                <asp:BoundColumn DataField="BillingName" SortExpression="BillingName" HeaderText="<%$ Resources:admin,BillingName %>" Visible="false"></asp:BoundColumn>
                ...
                <asp:TemplateColumn HeaderText="<%$ Resources:admin,Integration %>">
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink2" CssClass="btnDefault fancyContent" runat="Server" NavigateUrl='<%# string.format("{0}/admin/ecommerce/orders/EditIntegration.aspx?IND=" & DataBinder.Eval(Container.DataItem,"OrderId") & "&MID=" & 0 & "",BaseUrl) %> '>
                ...
                <asp:TemplateColumn HeaderText="<%$ Resources:admin,Select2 %>" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
