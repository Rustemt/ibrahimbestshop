<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="addmembertoplasiyer.ascx.vb" Inherits="ASPNetPortal.addmembertoplasiyer" %>
<%@ Register TagPrefix="ew" Namespace="eWorld.UI" Assembly="eWorld.UI" %>
<%@ Register Assembly="AjaxControls" Namespace="AjaxControls" TagPrefix="asp" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc3" %>
<div class="pagePlasiyerAddMember">
            ...
            <div class="col1-1">
                <div class="dataForm">
                    ...
                    <div class="row">
                        <div class="colOne">
                            <div class="radioList">
                                <asp:RadioButtonList runat="server" ID="rdbUye" CssClass="userList" AutoPostBack="True"></asp:RadioButtonList>
                                <asp:RequiredFieldValidator ErrorMessage="*" ControlToValidate="rdbUye" runat="server" ValidationGroup="adduye" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="colOne">
                            <asp:Button Text="<%$ Resources:admin,UsersCustomerRepresentativeAppointed %>" runat="server" ID="btnAdd" CssClass="btnDefault" ValidationGroup="adduye" />
                        </div>
                    </div>
                </div>
            </div>
