<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="offersendlist.ascx.vb" Inherits="offersendlist" %>
<%@ Register Assembly="AjaxControls" Namespace="AjaxControls" TagPrefix="asp" %>
<div class="pageOfferSendList">
    <asp:UpdatePanel ID="uPanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="buttonGroup">
                <asp:HyperLink ID="Linkaddnewoffertype" runat="server" CssClass="btnDefault fancyContent"><i class="fa fa-plus"></i> Yeni Sevkiyat Türü Ekle</asp:HyperLink>
            </div>
            <div class="dataTable">
                <asp:GridView ID="gvOfferTypeList" runat="server" GridLines="None" AutoGenerateColumns="False" DataKeyNames="id" EnableModelValidation="True" HeaderStyle-CssClass="title" HeaderStyle-HorizontalAlign="Left">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Sevkiyat Kodu">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="Server" CssClass="btnLink fancyContent" NavigateUrl='<%# "/admin/offer/editoffersend.aspx?IND=" & DataBinder.Eval(Container.DataItem, "id")%> '><%#DataBinder.Eval(Container.DataItem, "OfferSendCode")%>  </asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="OfferSendName" HeaderText="Sevkiyat Adı" ReadOnly="True" SortExpression="OfferSendName" />
                        <asp:BoundField DataField="OfferSendDesc" HeaderText="Sevkiyat Açıklaması" ReadOnly="True" SortExpression="OfferSendDesc" />
