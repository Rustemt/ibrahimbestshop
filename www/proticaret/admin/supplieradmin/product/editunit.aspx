		...
		<div class="toggleContent">
			...
			<div class="dataForm">
				...
				<div class="row">
					...
					<div class="colTwo">
					<label><asp:Label ID="Label12" runat="server" >Ýndirim(%):</asp:Label></label>
				...
				<div class="row">
					...
					<label>En-Boy-Yükseklik(cm) :</label>
