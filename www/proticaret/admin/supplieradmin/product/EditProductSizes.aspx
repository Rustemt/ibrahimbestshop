...
<%@ Page Language="vb" AutoEventWireup="false" Inherits="EditProductSizes1" Codebehind="EditProductSizes.aspx.vb" %>
...
<div class="pagePopup">
	<div class="boxToggle">
		...
		<div class="toggleContent">
			...
			<uc1:cproductsizelist ID="cproductsizelist2" runat="server"></uc1:cproductsizelist>
