...
<%@ Page Language="vb" ValidateRequest="false" AutoEventWireup="false" Inherits="ASPNetPortal.EditProductSizeOptionValue1" Codebehind="EditProductSizeOptionValue.aspx.vb" %>
			...
			<div class="dataForm">
				<div class="row">
					...
					<div class="colTwo colBtn">
						...
						<asp:HyperLink ID="showGalleryButton" runat="server" CssClass="btnDefault" NavigateUrl="#" onclick="BrowseServer('Src');" Text="Galeri"></asp:HyperLink>
					</div>
				</div>
			</div>
