<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="supplierproducts.ascx.vb" Inherits=".supplierproducts" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register TagPrefix="ew" Namespace="eWorld.UI" Assembly="eWorld.UI" %>
<%@ Register Assembly="AjaxControls" Namespace="AjaxControls" TagPrefix="asp" %>
<div class="pageSupplierProducts">
    <div class="buttonGroup">
        <asp:HyperLink ID="lnkAddNew" runat="server" CssClass="btnDefault fancyContent"><%= GetGlobalResourceObject("admin", "AddNew")%></asp:HyperLink>
    </div>
                        ...
                        <div class="tab">
                            <div class="colGroup">
                                ...
                                <div class="col">
                                    ...
                                    <cc1:AutoCompleteExtender ID="Markext" runat="server" TargetControlID="txtMark" ServicePath="/services/MarkService.asmx" ServiceMethod="GetMarks" MinimumPrefixLength="2" CompletionInterval="500" FirstRowSelected="true" EnableCaching="true" CompletionSetCount="12" OnClientItemSelected="selected" CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></cc1:AutoCompleteExtender>
                                ...
                                <div class="col">
                                    <label>&nbsp;</label>
                                    <asp:LinkButton ID="btnSearch" runat="server" CssClass="btnDefault"><%= GetGlobalResourceObject("admin","Search") %></asp:LinkButton>
                                </div>
                            </div>
            ...
            <div class="dataTable">
                <asp:DataGrid ID="Datagrid1" runat="server" GridLines="None" PageSize="20" AllowPaging="True" AutoGenerateColumns="False" AllowSorting="True" ShowFooter="True" HeaderStyle-CssClass="title">
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="CODE1" SortExpression="CODE1" HeaderText="<%$ Resources:admin,Code1 %>"></asp:BoundColumn>
                        ...
                        <asp:TemplateColumn HeaderText="<%$ Resources:admin,ConsumablesMaterial %>">
                            <ItemTemplate>
                                <asp:HyperLink ID="Hyperlink6" runat="Server" CssClass="btnIcon fancyContent" ToolTip="Sarf Malzemeleri" NavigateUrl='<%# "/admin/supplieradmin/product/EditUsages.aspx?IND=" & DataBinder.Eval(Container.DataItem, "ProductId")%> ' Enabled='<%# suppliesPre %>'><i class="fa fa-sitemap"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="<%$ Resources:admin,Alternative %>">
                            <ItemTemplate>
                                <asp:HyperLink ID="Hyperlink5" runat="Server" CssClass="btnIcon fancyContent" ToolTip="Ürün Alternatifleri" NavigateUrl='<%# "/admin/supplieradmin/product/EditAlteratives.aspx?IND=" & DataBinder.Eval(Container.DataItem, "ProductId")%> ' Enabled='<%# alternativePre %>'><i class="fa fa-star"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="<%$ Resources:admin,Variant2 %>">
                            <ItemTemplate>
                                <asp:HyperLink ID="Hyperlink7a" runat="Server" CssClass="btnIcon fancyContent" NavigateUrl='<%# "/admin/supplieradmin/product/EditProductVariants.aspx?IND=" & DataBinder.Eval(Container.DataItem, "ProductId")%> ' Enabled='<%# variantPre %>'><i class="fa fa-arrows"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="<%$ Resources:admin,ColorOrSize %>">
                            <ItemTemplate>
                                <asp:HyperLink ID="Hyperlink7" runat="Server" CssClass="btnIcon fancyContent" NavigateUrl='<%# "/admin/supplieradmin/product/EditProductSizes.aspx?IND=" & DataBinder.Eval(Container.DataItem, "ProductId")%> ' Enabled='<%# colorAndSizePre %>'><i class="fa fa-th-list"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="<%$ Resources:admin,Unit %>">
                            <ItemTemplate>
                                <asp:HyperLink ID="Hyperlink4" runat="Server" CssClass="btnIcon fancyContent" NavigateUrl='<%# "/admin/supplieradmin/product/EditUnits.aspx?IND=" & DataBinder.Eval(Container.DataItem, "ProductId")%> ' Enabled='<%# unitPre %>'><i class="fa fa-superscript"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <%--<asp:TemplateColumn HeaderText="<%$ Resources:admin,Picture %>" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <a style="visibility: <%# imagePre %>" data-width="600" data-height="400" class="btnIcon fancyContent" href='<%# "/admin/supplieradmin/product/EditImages.aspx?IND=" & DataBinder.Eval(Container.DataItem, "ProductId")%>'>
                                    <img alt="Resim" height="16px" src="<%# GetDefaultImagePath(DataBinder.Eval(Container.DataItem,"ProductId")) %>" />
                                    <%--<asp:Image ID="imgProd" ToolTip="Resim" Height="16px" ImageUrl='<%# GetDefaultImagePath(DataBinder.Eval(Container.DataItem,"ProductId")) %>' runat="server" />
                                </a>
                            </ItemTemplate>
                        </asp:TemplateColumn>--%>
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="<%$ Resources:admin,Picture %>">
                            <ItemTemplate>
                                <a class="btnIcon fancyContent" href='<%# "/admin/supplieradmin/product/EditImages.aspx?IND=" & DataBinder.Eval(Container.DataItem,"ProductId") &  "" %> '>
                                    <i class="fa fa-picture-o"></i></a>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Video" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:HyperLink ID="lnkvideo" runat="Server" CssClass="btnIcon fancyContent" ToolTip="Ürün Videosu" NavigateUrl='<%# "/admin/supplieradmin/product/EditVideo.aspx?IND=" & DataBinder.Eval(Container.DataItem, "ProductId")%> ' Enabled='<%# videoPre %>'><i class="fa fa-video-camera"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Teknik Tablo" Visible="false">
                            <ItemTemplate>
                                <asp:HyperLink ID="lnkto" runat="Server" CssClass="btnIcon fancyContent" ToolTip="Ürün Teknik Özellikleri" NavigateUrl='<%# "/admin/supplieradmin/wizard/editproductwizard.aspx?IND=" & DataBinder.Eval(Container.DataItem, "ProductId")%> ' Enabled="false"><i class="fa fa-table"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <%--
				<asp:TemplateColumn Visible="False" HeaderText="Dosya">
					<ItemTemplate>
                        ...
                        <asp:TemplateColumn HeaderText="Detay" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="Server" ToolTip="Ürün Detayı" CssClass="btnIcon fancyContent" NavigateUrl='<%# "/admin/ecommerce/product/EditProduct.aspx?IND=" & DataBinder.Eval(Container.DataItem, "ProductId")%> '><i class="fa fa-pencil"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
