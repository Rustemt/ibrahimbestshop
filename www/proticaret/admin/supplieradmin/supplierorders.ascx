<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="supplierorders.ascx.vb" Inherits="ASPNetPortal.supplierorders" %>
                        ...
                        <div class="tab">
                            ...
                            <div class="colGroup colGroupAdvanced">
                                <div class="col">
                                    ...
                                    <asp:DropDownList ID="ddlProvider" runat="server" Enabled="false">
                ...
                <asp:DataGrid ID="Datagrid1" runat="server" GridLines="None" AllowPaging="True" PageSize="50" AutoGenerateColumns="False" AllowSorting="True" HeaderStyle-CssClass="title">
                    <Columns>
                        ...
                        <asp:TemplateColumn SortExpression="OrderId" HeaderText="<%$ Resources:admin,OrderNoCode %>">
                            <ItemTemplate>
                                <asp:Label ID="lbll" runat="Server"><%#Eval("OrderId") & "/" & Eval("OrderCode")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="<%$ Resources:admin,ProductName %>">
                            <ItemTemplate>
                                ...
                                <asp:HyperLink ID="HyperLink12x" runat="Server" CssClass="btnLink fancyContent" ToolTip="Ürün Detayı" NavigateUrl='<%#"/admin/ecommerce/product/EditProduct.aspx?IND=" & DataBinder.Eval(Container.DataItem, "ProductId") & ""%> '><%# DataBinder.Eval(Container, "DataItem.ProductName") %></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
