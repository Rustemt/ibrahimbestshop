<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="edittesanbankinfo.aspx.vb" Inherits=".edittesanbankinfo" %>
				...
				<div class="col1-2">
					...
					<div class="row">
						<div class="colOne">
							...
							<p>Bankanın size vermiş olduğu faiz oranını girdikten sonra hesapla düğmesine basınız. Sistem size yansıyacak faiz oranını hesaplayacaktır.</p>
						</div>
					</div>
					<div class="row">
						<div class="colOne">
