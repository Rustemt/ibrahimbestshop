<%@ Page Language="vb" AutoEventWireup="false" Inherits="EditUsage" Codebehind="EditUsage.aspx.vb" %>
...
<div class="pagePopup">
	<div class="boxToggle">
		...
		<div class="toggleContent">
			...
			<asp:TemplateColumn HeaderText="<%$ Resources:admin,ConsumableMsg1 %>" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
				<ItemTemplate>
			...
			<%--
			<asp:TemplateColumn HeaderText="Sarf Malzeme Olarak Ekle">
				<ItemTemplate>
					<asp:LinkButton CssClass="Admin_Normal_Link" ID="lnkbtnDelete" runat="server" Text="Ekle"
