...
<%@ Page Language="vb" ValidateRequest="false" AutoEventWireup="false" Inherits="ASPNetPortal.EditProductSizesValues" Codebehind="EditProductSizesValues.aspx.vb" %>
...
<div class="pagePopup" style="width:800px;">
	<div class="boxToggle">
		...
		<div class="toggleContent">
			<div id="alert" runat="server" visible="false" class="alert alert-error">Ürün "Tekstil Formatýnda" deðil. Ürün detayýndan "Tekstil Formatý" seçiniz.</div>
				...
				<div class="row">
					<div class="colThree">
						...
						<div id="box0" runat="server">
							...
							<PagerStyle CssClass="Admin_TabloBaslik" Mode="NumericPages" Visible="False" />
							</asp:DataGrid>
							</div>
						</div>
					</div>
