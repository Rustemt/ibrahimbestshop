	...
	<div class="boxToggle">
		...
		<div class="toggleContent">
			...
			<div class="dataForm">
				<div class="row">
					<div class="colTwo">
						<label><%=GetGlobalResourceObject("admin", "TabName")%> : <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTabName" ErrorMessage="Tab Adý Girmelisiniz." >*</asp:RequiredFieldValidator></label>
