                    	...
                    	<div class="dataForm">
                            ...
                            <div class="row">
                                <div class="colOne">
                                    ...
                                    <asp:Button ID="btnUpdatePrice" CssClass="btnDefault" runat="server" Text="Fiyat Güncelle" Visible="false" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="colOne"><b>Finansal Kampanya Güncelleme</b></div>
                            </div>
                            <div class="row">
                                <div class="colOne">
                            ...
                            <div class="row">
                                <div class="colOne">
									...
									<asp:Button ID="btnupdetecampain" CssClass="btnDefault" runat="server" Text="Finansal Kampanya Güncelle" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="colOne">
                                    ...
                                    <asp:DropDownList ID="ddlBoyut" runat="server">
                                        ...
                                        <%--Desi alaný value deðeri yok--%>
                                        <asp:ListItem Text="<%$ Resources:admin,Widht2 %>"></asp:ListItem>
                                        <%--En alaný value deðeri yok--%>
                                        <%-- <asp:ListItem Text="<%$ Resources:admin,Height %>"></asp:ListItem> Boy alaný value deðeri yok--%>
