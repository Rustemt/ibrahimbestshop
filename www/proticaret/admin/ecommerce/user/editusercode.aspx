<%@ Page Language="vb" AutoEventWireup="false" Inherits="ASPNetPortal.EditUserCode" Codebehind="EditUserCode.aspx.vb" %>
	...
	<div class="boxToggle">
		...
		<div class="toggleContent">
			...
			<div class="dataForm">
				<div class="row">
					<div class="colTwo">
						<label><%=GetGlobalResourceObject("admin", "CodeName")%> : <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtIl" ErrorMessage="<%$ Resources:admin,CodeNameMsg1 %>.">*</asp:RequiredFieldValidator></label>
