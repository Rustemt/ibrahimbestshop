<%@ Control Language="vb" AutoEventWireup="false" Inherits="cxlsimport" CodeBehind="cxlsimport.ascx.vb" %>
                            ...
                            <ul>
                                <li>
                                    <label class="labelInput">
                                        <asp:CheckBox ID="chkUpdateName" runat="server" Text="<%$ Resources:admin,UpdateProductName %>" />
                                    </label>
                                </li>
                                <li>
                                    <label class="labelInput">
                                        <asp:CheckBox ID="chkUpdateCodes" runat="server" Text="<%$ Resources:admin,ProductSpecialCodesUpdate %>" />
                                    </label>
                                </li>
                                <li>
                                    <label class="labelInput">
                                        <asp:CheckBox ID="chkUpdateDetails" runat="server" Text="<%$ Resources:admin,ProductDetailUpdate %>" />
                                    </label>
                                </li>
                                <li>
                                    <label class="labelInput">
                                        <asp:CheckBox ID="chkupdatekeywords" runat="server" Text="<%$ Resources:admin,SearchYourWordsUpdate %>" />
                                    </label>
                                </li>
                            </ul>
                        </div>
