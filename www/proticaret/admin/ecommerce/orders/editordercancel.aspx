<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="editordercancel.aspx.vb" Inherits="ASPNetPortal.editordercancel" %>
        ...
        <div class="pagePopup" id="orderDetail" runat="server">
            <div class="boxToggle">
                <div class="toggleTitle">
                    <div class="titleText">Sipariş Detayı</div>
                </div>
                        ...
                        <div class="dataForm">
                                    ...
                                    <div class="dataForm">
                                        <div class="row">
                                            ...
                                            <div class="colThree">
                                                ...
                                                <div class="row">
                                                    <div class="colTwo">
                                                        <label>İade Talebi :</label>
                                                        <asp:Label ID="lblRequestName" runat="server"></asp:Label>&nbsp;
                                                        <asp:LinkButton runat="server" CssClass="btnDefault" ID="lnkCoupon"><i class="fa fa-ticket"></i> Kupon Oluştur</asp:LinkButton>
                                                    </div>
                                                    <div class="colTwo">
                                                        <label>İade - Değişim Nedeni :</label>
                                                        <asp:Label ID="lblReasonName" runat="server"></asp:Label>
                                                    </div>
                                                </div>

                                                <div class="row">
                                                    <div class="colOne">
                                                        <label>Onaylama Tarihi :</label>
                                                        <asp:Label runat="server" ID="lblActiveDate"></asp:Label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" runat="server" visible="false">
                                                    <div class="colOne colBtn">
                                                        <label><%=GetGlobalResourceObject("admin", "Status")%> :</label>
                                                        <label class="labelInput"><a id="a1" class="textRed" runat="server"></a></label>
                                                        <a class="btnDefault" href="#" data-width="1250" data-height="600" onclick="EditStatus()"><i class="fa fa-pencil"></i>Düzenle</a>
                                                    </div>
                                                    <div class="colOne colBtn">
                                            ...
                                            <div class="colThree">
                                                <div class="row">
                                                    <div class="colOne">
                                                        <label>Iban Numarasi :</label>
                                                        <asp:Label ID="Note" runat="server"></asp:Label>
                                                    </div>
                                                    <div class="colOne">
                                                        <label>İade - Değişim Notu :</label>
                            ...
                            <div class="row">
                                <div class="colOne">
                                    ...
                                    <div class="dataTable">
                                        <asp:DataGrid ID="Datagrid1" runat="server" GridLines="None" HeaderStyle-CssClass="title" AutoGenerateColumns="False">
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="İade Adedi" HeaderStyle-HorizontalAlign="Right">
                                                    <ItemTemplate><%#DataBinder.Eval(Container, "DataItem.IadeAdedi2")%> <%#IIf(ChkNullInteger(DataBinder.Eval(Container, "DataItem.IadeAdedi2")) <> 0, DataBinder.Eval(Container, "DataItem.BirimAdi"), "")%> </ItemTemplate>
                                                </asp:TemplateColumn>
                                                ...
                                                <asp:TemplateColumn HeaderText="İade-Değişim Durumu">
                                                    <ItemTemplate>
                                                        ...
                                                        <a href="javascript:void(0)" class="textRed" onclick="<%# "popupWindow(430,200,50,'EditCancelStatus.aspx?IND=" & DataBinder.Eval(Container.DataItem, "OrderDetailsId") & "&DIND=" & DataBinder.Eval(Container.DataItem, "CancelOrderId") & "','popup');"%>"><%#Eval("StatusName3")%></a>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="Sipariş Durumu">
                                                    <ItemTemplate>
                                                        <%--<asp:HyperLink ID="HyperLink1" CssClass="textRed" runat="Server" Enabled="<%#update%>" NavigateUrl='<%# "Javascript:var PopUpWin = window.open(""EditStatus.aspx?IND=" & DataBinder.Eval(Container.DataItem,"OrderDetailsId") & "&DIND=" & DataBinder.Eval(Container.DataItem,"OrderId") & ""","""",""width=430,height=200,top=1,left=1,scrollbars=yes,toolbar=0,status=1,resizable=1"")" %> '><%#DataBinder.Eval(Container, "DataItem.StatusName2")%></asp:HyperLink>--%>
                                    ...
                                    <div class="boxToggle">
                                        <div class="toggleTitle">
                                            <div class="titleText">Toplam Sipariş Bilgileri</div>
                                        </div>
                                        <div class="toggleContent">
...
<script type="text/javascript">
    ...
    function EditStatus() {
        var i = "<%= MID %>";
        popupWindow(700, 250, 50, '/admin/ecommerce/orders/EditCancelStatus.aspx?IND=-100&DIND=' + i, 'popup');
    }
    function AllOrders() {
        var a = "<%= email  %>";
