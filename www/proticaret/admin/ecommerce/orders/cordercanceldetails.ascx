<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="cordercanceldetails.ascx.vb" Inherits="ASPNetPortal.cordercanceldetails" %>
                ...
                <div class="dataTable" style="overflow-x: scroll;">
                    <div>
                        <asp:DataGrid ID="Datagrid1" runat="server" GridLines="None" AllowPaging="True" ShowFooter="true" PageSize="20" AutoGenerateColumns="False" AllowSorting="True" HeaderStyle-CssClass="title" FooterStyle-HorizontalAlign="Center">
                            <Columns>
                                <asp:BoundColumn DataField="CancelOrderId" SortExpression="CancelOrderId" HeaderText="İade/Değişim No/Kodu" Visible="false"></asp:BoundColumn>
                                ...
                                <asp:TemplateColumn ItemStyle-Wrap="false" HeaderText="<%$ Resources:admin,ProductName %>" SortExpression="ProductName">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink3" runat="Server" CssClass="btnLink fancyContent" NavigateUrl='<%# "/admin/ecommerce/product/EditProduct.aspx?IND=" & DataBinder.Eval(Container.DataItem,"ProductId") %>'><%#Eval("ProductCode")%> - <%#Eval("ProductName")%></asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:BoundColumn DataField="CancelQty" SortExpression="CancelQty" HeaderText="İade Miktarı"></asp:BoundColumn>

                                <asp:TemplateColumn HeaderText="<%$ Resources:admin,PaymentType %>" SortExpression="PaymentType" Visible="false">
                                    <ItemTemplate>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                ...
                                <asp:BoundColumn DataField="RequestName" SortExpression="RequestName" HeaderText="İade Talebi"></asp:BoundColumn>
                                <asp:TemplateColumn SortExpression="OrderId" HeaderText="Sipariş No/Kodu" ItemStyle-CssClass="linkContainer">
                                    <ItemTemplate>
                                        ...
                                        <div class="linkContent">
                                            <table border="0">
                                                <tr>
                                                    <td width="140">Ödeme Şekli-Bankası</td>
                                                    <td>
                                                        <asp:Label ID="Label1" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PaymentType") & "-" & DataBinder.Eval(Container, "DataItem.BankName") %>'></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td>Üye Açıklaması</td>
                                                    <td><%# DataBinder.Eval(Container, "DataItem.Note") %></td>
                                                </tr>
                                                <tr>
                                                    <td>Yönetici Açıklaması</td>
