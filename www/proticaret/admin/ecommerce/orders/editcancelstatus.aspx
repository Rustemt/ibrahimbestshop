<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="editcancelstatus.aspx.vb" Inherits="ASPNetPortal.editcancelstatus" %>
		...
		<div class="toggleContent">
			...
			<div class="dataForm">
				<div class="row">
					...
					<div class="colTwo">
						<label><asp:Label ID="lblStatus2" runat="server" Visible="False">Satış Ortağı Durumu :</asp:Label></label>
