<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="GGproductlist.ascx.vb" Inherits="ASPNetPortal.GGproductlist" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register TagPrefix="ew" Namespace="eWorld.UI" Assembly="eWorld.UI" %>
<%@ Register Assembly="AjaxControls" Namespace="AjaxControls" TagPrefix="asp" %>

<div id="pageGGProducts" class="module">
                        ...
                        <div class="tab">
                            <div class="colGroup">
                                ...
                                <div class="col colAuto">
                                    <label>&nbsp;</label>
                                    <asp:LinkButton ID="btnSearch" runat="server" CssClass="btnDefault" CausesValidation="false"  Visible="true"><i class="fa fa-search"></i> <%= GetGlobalResourceObject("admin","Search") %></asp:LinkButton>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col1-1">
                        <div class="dataForm">
                            <div class="row">
                                <div class="colOne">
                                    <label><%=GetGlobalResourceObject("admin", "FilterTransferProductsToGG")%></label>
                                    <hr />
                                    <div class="alert alert-info"><%=GetGlobalResourceObject("admin", "BulkProductDeletionMsg1")%></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="colOne">
                                    <label><%=GetGlobalResourceObject("admin", "ListingDayCount")%></label>
                                    <asp:TextBox ID="txtListingDays" runat="server" ValidationGroup="n11"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfv2"  ControlToValidate="txtListingDays" runat="server" ><%=GetGlobalResourceObject("admin", "GGMsg3")%></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="colOne">
                                    <label><%=GetGlobalResourceObject("admin", "SalesStartDate")%></label>
                                    <ew:CalendarPopup ID="dtSalesStartDate" runat="server" CalendarLocation="Bottom" Width="350" GoToTodayText="Bu Gün:" ClearDateText="Sil" ShowGoToToday="True" Nullable="True" AllowArbitraryText="False" DisableTextBoxEntry="False" Text="..."></ew:CalendarPopup>
                                </div>
                            </div>
                            <div class="row">
                                <div class="colOne">
                                    <asp:Label ID="Label45" runat="server"></asp:Label>
                                    <asp:Button ID="btnSendGG" CssClass="btnDefault" runat="server" CausesValidation="true"  Text="<%$ Resources:admin,TransferProductsToGG %>" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col1-3">
                        <div class="dataTable">
                            <asp:DataGrid ID="Datagrid1" runat="server" GridLines="None" HeaderStyle-CssClass="title" PageSize="20" AllowPaging="True" AutoGenerateColumns="False" AllowSorting="True">
                                <Columns>
                                    ...
                                    <asp:TemplateColumn SortExpression="ProductCode" HeaderText="<%$ Resources:admin,ProductCode2 %>">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderText="<%$ Resources:admin,ColorOrSize %>" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:HyperLink CssClass="btnIcon fancyContent" ID="Hyperlink7" runat="Server" NavigateUrl='<%# "/admin/ecommerce/product/EditProductSizes.aspx?IND=" & DataBinder.Eval(Container.DataItem,"ProductId") %> '><i class="fa fa-superscript"></i>  </asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                        ...
                        <div class="dataCount">
                            <ul>
                                ...
                                <li><%=GetGlobalResourceObject("admin", "TotalRecording")%>:<asp:Label ID="lblPageCount" runat="server"></asp:Label></li>
                                <li><%=GetGlobalResourceObject("admin", "TotalPage")%>:<asp:Label ID="lblCurrentIndex" runat="server"></asp:Label></li>
                            </ul>
                        </div>
                    </div>
                </div>
