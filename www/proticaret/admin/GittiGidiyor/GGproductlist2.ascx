<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="GGproductlist2.ascx.vb" Inherits="ASPNetPortal.GGproductlist2" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register TagPrefix="ew" Namespace="eWorld.UI" Assembly="eWorld.UI" %>
<%@ Register Assembly="AjaxControls" Namespace="AjaxControls" TagPrefix="asp" %>

<div id="cProductList2" class="module">
                    ...
                    <div class="row">
                        <div class="col1-1">
                            <div class="dataForm">
                                ...
                                <div class="row">
                                    <div class="colOne">
                                        <label><%=GetGlobalResourceObject("admin", "UpdateFilterProductsStock")%></label>
                                        <asp:Button ID="btnStockQty" CssClass="btnDefault" runat="server" CausesValidation="false" Text="<%$ Resources:admin,UpdateStock %>" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="colOne">
                                        <label><%=GetGlobalResourceObject("admin", "UpdateFilterProductsPrice")%></label>
                                        <asp:Button ID="btnPriceUpdate" CssClass="btnDefault" runat="server" CausesValidation="false" Text="<%$ Resources:admin,UpdatePrices %>" />
                                    </div>
                                </div>
                            </div>
                        </div>
