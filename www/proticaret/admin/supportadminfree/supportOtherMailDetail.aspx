<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="supportOtherMailDetail.aspx.vb" Inherits="ASPNetPortal.supportOtherMailDetail2" ValidateRequest="false" %>
                                    ...
                                    <div class="toggleContent">
                                        <div class="colGroup">
                                            <div class="col">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="<%$ Resources:admin,Select %>" ControlToValidate="ddlCategory" InitialValue="0"></asp:RequiredFieldValidator>
                                                <asp:DropDownList runat="server" ID="ddlCategory"></asp:DropDownList>
                                            </div>
                                            <div class="col">
                                                <label runat="server"><%= GetGlobalResourceObject("admin","Status") %></label>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$ Resources:admin,Select %>" ControlToValidate="ddlStatus" InitialValue="0"></asp:RequiredFieldValidator>
                                                <asp:DropDownList runat="server" ID="ddlStatus"></asp:DropDownList>
                                            </div>
                                            <div class="col">
                                                <label runat="server"><%= GetGlobalResourceObject("admin","ResponsiblePersonnel") %></label>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="<%$ Resources:admin,Select %>" ControlToValidate="ddlUser" InitialValue="0"></asp:RequiredFieldValidator>
                            ...
                            <div class="dataForm">
                                ...
                                <div class="row">
                                    <div class="colTwo">
                                        ...
                                        <label class="labelInput">
                                            <asp:Label runat="server" ID="lblSupportId"></asp:Label></label>
                                    </div>
                                    <div class="colTwo">
                                ...
                                <div class="row">
                                    <div class="colTwo">
                                        ...
                                        <label class="labelInput">
                                            <asp:Label runat="server" ID="lblUserName"></asp:Label></label>
                                    </div>
                                    <div class="colTwo">
                                        <label runat="server"><%= GetGlobalResourceObject("admin","Email") %> :</label>
                                        <label class="labelInput">
                                            <asp:Label runat="server" ID="lblUserMail"></asp:Label></label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="colOne">
                                        ...
                                        <asp:Repeater runat="server" ID="rptFile">
                                            ...
                                            <ItemTemplate>
                                                <li>
                                                    <asp:LinkButton runat="server" CausesValidation="false" ID="lnk" CommandName="download" CssClass="textRed" CommandArgument="<%# Container.DataItem %>" Text=" <%# Container.DataItem %>"></asp:LinkButton></li>
                                            </ItemTemplate>
                                ...
                                <div class="row">
                                    <div class="colOne">
                                        <label runat="server"><%= GetGlobalResourceObject("admin","Reply") %></label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="<%$ Resources:admin,NotEmpty %>" ControlToValidate="txtCevap" ValidationGroup="1"></asp:RequiredFieldValidator>
                                ...
                                <div class="row">
                                    ...
                                    <div class="colTwo">
                                        <label>&nbsp;</label>
                                        <asp:Button ID="btnCevap" runat="server" Text="<%$ Resources:admin,Reply %>" CssClass="btnDefault" ValidationGroup="1"></asp:Button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <asp:Repeater runat="server" ID="rptComment">
                                <ItemTemplate>
                                    <div class='<%# iif(Eval("IsAnswer"),"alert alert-info","alert") %>'>
                                        <p>
                                            <b>
                                                <asp:Label runat="server" ID="lblMail"></asp:Label></b> &nbsp;<small><asp:Label runat="server" ID="lblDate" Text='<%# Eval("Date") %>'></asp:Label></small>
                                        </p>
