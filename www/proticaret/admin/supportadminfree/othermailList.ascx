<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="othermailList.ascx.vb" Inherits=".othermailList" %>
...
<div class="pageAdminFreeMails">
    ...
    <asp:HyperLink ID="hypnew" runat="Server" CssClass="fancyContent btnDefault"><i class="fa fa-plus"></i> <%= GetGlobalResourceObject("admin","CreateNewRequest") %></asp:HyperLink>
    <div class="dataTable">
