<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="statuslist.ascx.vb" Inherits=".statuslist" %>
<div class="pageSupportFreeStatus">
    <asp:Label ID="lblerr" runat="server"></asp:Label>
    <div class="buttonGroup">
        <asp:HyperLink ID="lnkAddNew" runat="server" CssClass="btnDefault fancyContent" NavigateUrl="/admin/supportadminfree/EditStatus.aspx?IND=0"><i class="fa fa-plus"></i> <%=GetGlobalResourceObject("admin","AddNew") %></asp:HyperLink>
    </div>
    <div class="dataTable">
        <asp:DataGrid ID="stList" runat="server" GridLines="None" AutoGenerateColumns="False" HeaderStyle-CssClass="title">
            <Columns>
                ...
                <asp:TemplateColumn HeaderText="<%$ Resources:admin,StatusName %>">
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink3" runat="Server" CssClass="btnLink fancyContent" NavigateUrl='<%# "/admin/supportadminfree/EditStatus.aspx?IND=" & DataBinder.Eval(Container.DataItem, "SupportStatusId") & "&MID=" & 0%> '><%#Eval("SupportStatusName")%></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateColumn>
