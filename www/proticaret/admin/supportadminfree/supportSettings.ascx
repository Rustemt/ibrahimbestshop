<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="supportSettings.ascx.vb" Inherits=".supportSettings" %>
    ...
    <div class="dataForm">
        <div class="row">
            <div class="colTwo">
                ...
                <asp:TextBox runat="server" ID="txtsendername"></asp:TextBox>
            </div>
            <div class="colTwo">
                <label><%= GetGlobalResourceObject("admin","SenderPasword") %></label>
                <asp:TextBox runat="server" ID="txtsenderpassword"></asp:TextBox>
            </div>
        </div>
        <div class="row">
            <div class="colTwo">
