<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="c2c_editcompanyorder.aspx.vb" Inherits="ASPNetPortal.c2c_editcompanyorder" %>
...
<script type="text/javascript">
    ...
    function EditStatus() {
        var i = "<%= IND %>";
        var j = "<%= MID%>";
        popupWindow(430, 200, 50, '/admin/c2c/order/c2c_editstatus.aspx?IND=' + i + '&DIND=' + j, 'popup');
