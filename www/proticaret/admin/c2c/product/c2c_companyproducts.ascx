<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="c2c_companyproducts.ascx.vb" Inherits="ASPNetPortal.c2c_companyproducts" %>
                ...
                <asp:DataGrid ID="Datagrid1" runat="server" GridLines="None" PageSize="20" AllowPaging="True" AutoGenerateColumns="False" AllowSorting="True" HeaderStyle-CssClass="title" FooterStyle-HorizontalAlign="Center" ShowFooter="True">
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="<%$ Resources:admin,Variant2 %>">
                            <ItemTemplate>
                                <asp:HyperLink Enabled='<%# AddVariant %>' CssClass="btnIcon fancyContent" ID="Hyperlink7a" runat="Server" NavigateUrl='<%# "/admin/ecommerce/product/EditProductVariants.aspx?IND=" & DataBinder.Eval(Container.DataItem, "ProductId") & ""%> '><i class="fa fa-arrows"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="<%$ Resources:admin,ConsumablesMaterial %>">
                            <ItemTemplate>
                                <asp:HyperLink Enabled='<%# AddSupplies %>' ToolTip="Sarf Malzemeleri" CssClass="btnIcon fancyContent" ID="Hyperlink6" runat="Server" NavigateUrl='<%# "/admin/ecommerce/product/EditUsages.aspx?IND=" & DataBinder.Eval(Container.DataItem,"ProductId") &  "" %> '><i class="fa fa-sitemap"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="<%$ Resources:admin,ColorOrSize %>">
                            <ItemTemplate>
                                <asp:HyperLink Enabled='<%# AddColorAndSize  %>' CssClass="btnIcon fancyContent" ID="Hyperlink7" runat="Server" NavigateUrl='<%# "/admin/ecommerce/product/EditProductSizes.aspx?IND=" & DataBinder.Eval(Container.DataItem,"ProductId") &  "" %> '><i class="fa fa-th-list"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="Set">
                            <ItemTemplate>
                                <asp:HyperLink Enabled='<%# AddDifferentProduct %>' CssClass="btnIcon fancyContent" ID="hypgroups" runat="Server" NavigateUrl='<%# "/admin/ecommerce/product/EditGroups.aspx?IND=" & DataBinder.Eval(Container.DataItem,"ProductId") %> '>
                        ...
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="<%$ Resources:admin,Unit %>">
                            <ItemTemplate>
                                <asp:HyperLink Enabled='<%# AddUnit%>' CssClass="btnIcon fancyContent" ID="Hyperlink4" runat="Server" NavigateUrl='<%# "/admin/ecommerce/product/EditUnits.aspx?IND=" & DataBinder.Eval(Container.DataItem,"ProductId") &  "" %> '><i class="fa fa-superscript"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="Video">
                            <ItemTemplate>
                                <asp:HyperLink Enabled='<%# AddVideo %>' ToolTip="Ürün Videosu" CssClass="btnIcon fancyContent" ID="lnkvideo" runat="Server" NavigateUrl='<%# "/admin/ecommerce/product/EditVideo.aspx?IND=" & DataBinder.Eval(Container.DataItem, "ProductId") & ""%> '><i class="fa fa-video-camera"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="<%$ Resources:admin,ThreeDPicture %>">
                            <ItemTemplate>
                                <asp:HyperLink Enabled='<%# AddImage %>' ToolTip="Ürün 3D Resmi" CssClass="btnIcon fancyContent" ID="lnk3dPicture" runat="Server" NavigateUrl='<%# "/admin/ecommerce/product/Edit3dPicture.aspx?IND=" & DataBinder.Eval(Container.DataItem, "ProductId") & ""%> '><i class="fa fa-cube"></i></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
