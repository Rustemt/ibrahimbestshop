<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="editn11order.aspx.vb" Inherits="ASPNetPortal.editn11order" %>
                                    ...
                                    <div class="dataForm">
                                        <div class="row">
                                            ...
                                            <div class="colThree">
                                                <div class="row">
                                                    <div class="colOne colBtn">
                                                        ...
                                                        <asp:HyperLink ID="lnkUserOrders" runat="server" CssClass="btnDefault"></asp:HyperLink>
                                                    </div>
                                                    <div class="colOne colBtn">
                                                        <label><%=GetGlobalResourceObject("admin", "Email")%> :</label>
                                                        <label class="labelInput">
                                                            <asp:Label ID="lblEmail" runat="server"></asp:Label></label>
                                                        <asp:HyperLink ID="lnkEmail" runat="server" CssClass="btnDefault"></asp:HyperLink>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="colOne colBtn">
                                                        ...
                                                        <asp:HyperLink ID="editPoint" runat="server" CssClass="btnDefault"><%=GetGlobalResourceObject("admin", "Edit")%></asp:HyperLink>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="colThree">
                                                <div class="row">
                                                    <div class="colOne">
                                                        <label><%=GetGlobalResourceObject("admin", "N11OrderIdandNumber")%> :</label>
                            ...
                            <div class="row">
                                <div class="colOne">
                                    <div class="buttonGroup margin-none-top">
                                        <asp:HyperLink ID="hypWhole" runat="Server" CssClass="editbutton" ToolTip="Seri Detayı" Visible="false">Seri Detayı
                                        </asp:HyperLink>
                                        <asp:HyperLink ID="hlCurtain" runat="Server" CssClass="editbutton" ToolTip="Perde Detayı" Visible="false">Perde Detayı
                                        </asp:HyperLink>
                                        <asp:HyperLink ID="hypPoster" runat="Server" CssClass="editbutton" ToolTip="Poster Detayı" Visible="false">Poster Detayı
                                        </asp:HyperLink>
                                        <asp:HyperLink ID="hypFood" runat="Server" CssClass="editbutton" ToolTip="Yemek Detayı" Visible="false">Yemek Detayı
                                        </asp:HyperLink>
                                        <asp:HyperLink ID="hypFlower" runat="Server" CssClass="editbutton" ToolTip="Çiçek Detayı" Visible="false">Çiçek Detayı
                                        </asp:HyperLink>
                                    </div>
                                    <div class="dataTable">
                                        <asp:DataGrid ID="Datagrid1" runat="server" GridLines="None" HeaderStyle-CssClass="title" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                <asp:BoundColumn DataField="OrderDetailsId" HeaderText="ID">
                                                    <HeaderStyle Width="0px"></HeaderStyle>
                                                </asp:BoundColumn>
                                                <%--<asp:BoundColumn DataField="Ürün Kodu" HeaderText="Ürün Kodu"></asp:BoundColumn>--%>
                                                <asp:TemplateColumn HeaderText="<%$ Resources:admin,ProductCode %>">
                                                    <ItemTemplate>
                                                        <%#DataBinder.Eval(Container, "DataItem.ProductCode")%>
                                                        <%#IIf(ChkNullString(DataBinder.Eval(Container, "DataItem.ProductBarcode")) <> "", "<br>Barkod:" & DataBinder.Eval(Container, "DataItem.ProductBarcode"), "")%>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:BoundColumn DataField="ProductName" HeaderText="<%$ Resources:admin,ProductName %>"></asp:BoundColumn>
                                                <%--<asp:BoundColumn DataField="Description" HeaderText="Ürün Özellikleri"></asp:BoundColumn> --%>
                                                <asp:TemplateColumn HeaderText="<%$ Resources:admin,ProductFeatures %>">
                                                    <ItemTemplate>
                                                        <%#DataBinder.Eval(Container, "DataItem.Description").ToString.Replace("<div>","").Replace("</div>","")%>
                                                        <%# iif(ChkNullString(DataBinder.Eval(Container, "DataItem.ProductSizeBarcode"))<>"","<br>Barkod:" & DataBinder.Eval(Container, "DataItem.ProductSizeBarcode"),"")%>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="<%$ Resources:admin,Provider %>">
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkted" runat="Server" NavigateUrl='<%# "Javascript:var PopUpWin = window.open(""/storeadmin/providers/ProviderInfo.aspx?IND=" & DataBinder.Eval(Container.DataItem,"ProviderId") & "&DIND=" & DataBinder.Eval(Container.DataItem,"OrderId") & ""","""",""width=400,height=650,top=1,left=1,scrollbars=yes,toolbar=0,status=1,resizable=1"")" %> '>
                                                ...
                                                <%--<asp:BoundColumn DataField="BirimAdi" HeaderText="Birim" ItemStyle-HorizontalAlign="Right"></asp:BoundColumn>        --%>
                                                <asp:TemplateColumn HeaderText="<%$ Resources:admin,Quantity %>" HeaderStyle-HorizontalAlign="Right">
                                                    <ItemTemplate>
                                                        <%#DataBinder.Eval(Container, "DataItem.Quantity")%>
                                                        <%#DataBinder.Eval(Container, "DataItem.BirimAdi")%>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                ...
                                                <asp:TemplateColumn HeaderText="<%$ Resources:admin,CurrencyAmount %>">
                                                    <ItemTemplate>
                                                        <%--   <asp:Label ID="Label35" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.SatisFiyati", "{0:0.00} ") & DataBinder.Eval(Container, "DataItem.CurrencyName") %>'>
                                </asp:Label>--%>
                                                        <asp:Label ID="Label35" runat="server" Text='<%# FormatCurDoviz(Eval("SatisFiyati") / Eval("CurrencyRate")) & " " & Eval("CurrencyCode") %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="<%$ Resources:admin,UnitPrice %>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label runat="server" Text='<%# FormatCurDoviz(CalcRate(CalcIndirim(CalcIndirim(container.dataitem("SatisFiyati") ,container.dataitem("BirimIndirimOrani")),container.dataitem("CariIndirimOrani")),container.dataitem("Rate") / container.dataitem("CurrencyRate")))  & " " & container.dataitem("CurrencyCode")%>' ID="BirimFiyat">
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="<%$ Resources:admin,PurchasePrice %>">
                                                    ...
                                                    <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                    <ItemTemplate>
                                                        <asp:Label ID="AlisTutar" runat="server" Text='<%# FormatCurDoviz(CalcRate(container.dataitem("AlisFiyati") , container.dataitem("AlisRate") / container.dataitem("CurrencyRate")) * container.dataitem("Quantity")) & " " & container.dataitem("CurrencyCode")%>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="<%$ Resources:admin,Tax %>">
                                                    ...
                                                    <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                    <ItemTemplate>
                                                        <%# formatCurDoviz(CalcKdv(CalcRate(CalcIndirim(CalcIndirim(Container.DataItem("SatisFiyati"), Container.DataItem("BirimIndirimOrani")), Container.DataItem("CariIndirimOrani")) * Container.DataItem("Quantity"), Container.DataItem("Rate") / Container.DataItem("CurrencyRate")), Container.DataItem("KdvRate"))) & " " & Container.DataItem("CurrencyCode") %>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="<%$ Resources:admin,Amount %>">
                                                    ...
                                                    <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                    <ItemTemplate>
                                                        <asp:Label ID="Tutar" runat="server" Text='<%# FormatCurDoviz(CalcIndirim(CalcIndirim(CalcRate(container.dataitem("SatisFiyati") , container.dataitem("Rate") / Container.DataItem("CurrencyRate") ),container.dataitem("BirimIndirimOrani")),container.dataitem("CariIndirimOrani")) * container.dataitem("Quantity")) & " " & Container.DataItem("CurrencyCode") %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="<%$ Resources:admin,Status %>">
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="HyperLink1" runat="Server" Enabled="<%#update%>" NavigateUrl='<%# "Javascript:var PopUpWin = window.open(""/admin/ecommerce/orders/EditStatus.aspx?IND=" & DataBinder.Eval(Container.DataItem,"OrderDetailsId") & "&DIND=" & DataBinder.Eval(Container.DataItem,"OrderId") & ""","""",""width=350,height=150,top=1,left=1,scrollbars=yes,toolbar=0,status=1,resizable=1"")" %> '>
                                                            <%#DataBinder.Eval(Container, "DataItem.StatusName2")%>
                                                        </asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="<%$ Resources:admin,Detail %>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="HyperLink12x" runat="Server"  CssClass="btnIcon" NavigateUrl='<%# "Javascript:var PopUpWin = window.open(""/admin/ecommerce/product/EditProduct.aspx?IND=" & DataBinder.Eval(Container.DataItem,"ProductId") & ""","""",""width=900,height=670,scrollbars=1,toolbar=0,status=1,resizable=1"")" %> '
                                                            ToolTip="Ürün Detayı"><i class="fa fa-pencil"></i>
                                                        </asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="<%$ Resources:admin,Delete %>" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center" >
                                                    <ItemTemplate>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <asp:HyperLink ID="lnkSendSms" runat="server" ForeColor="Red"></asp:HyperLink>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                            ...
                                                            <table width="100%" cellpadding="5" cellspacing="0" border="0" runat="server">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lblToplamTutar2" runat="server" CssClass="textRed"></asp:Label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><%=GetGlobalResourceObject("admin", "TotalPurchaseAmount")%> :</td>
                                                                        <td>
                                                                            <asp:Label ID="lblToplamAlis2" runat="server" CssClass="textRed"></asp:Label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><%=GetGlobalResourceObject("admin", "TotalAvailsAmount")%> :</td>
                                                                        <td>
                                                                            <asp:Label ID="lblkar" runat="server" CssClass="textRed"></asp:Label></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </td>
                                                        <td valign="top" width="33%">
                                                            <table width="100%" cellpadding="5" cellspacing="0" border="0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td width="95"><%=GetGlobalResourceObject("admin", "TotalDiscount")%> :</td>
                                                                        <td>
