<%@ Page Language="vb" AutoEventWireup="false" Inherits="ASPNetPortal.Request" Codebehind="request.aspx.vb" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="head1" runat="server">  
    <title><%=GetGlobalResourceObject("lang", "AffiliateRequest")%> : <%= ConfigurationManager.AppSettings("SiteName") %></title>    
</head>
<body>
<div id="container">
		...
		<div id="center_middle">
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<td id="middle_right" runat="server" valign="top"></td>
				</tr>
			</table>
		</div>
