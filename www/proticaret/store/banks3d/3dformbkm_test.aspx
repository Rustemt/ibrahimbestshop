...
<head runat="server" id="head1">
 ...
 window.parent.document.getElementById(window.parent.window['ParentClientId'] + "_txstatus").value=1;
    ...
    %>
        ...
        <div >
               ...
               <input type="submit" value="Ödemeyi Tamamla"/> 
                ...
                <a href="javascript:HideFrameErr()" class="Global_Normal_Link" id="A1" >Kapat(Başarısız)</a> 
