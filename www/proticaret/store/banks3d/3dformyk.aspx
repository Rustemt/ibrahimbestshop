...
var res='';
res =String(result);
document.getElementById('posnetReturn').value = res;
if (res.indexOf('|')>0)
{
var rar=res.split('|');
...
document.forms[0].action= '<%=Session("Bank3dGetWayAddress")%>'//"https://www.posnet.ykb.com/3DSWebService/YKBPaymentService"
...
{
document.getElementById('posnetData').value=''
document.getElementById('posnetData2').value=''
document.getElementById('digest').value=''
document.forms[0].action='<%= iif(Request.IsSecureConnection, BaseUrl.Replace("http://", "https://") & "/store/banks3d/3dodemeyk.aspx", BaseUrl & "/store/banks3d/3dodemeyk.aspx")%>' //"https://www.posnet.ykb.com/3DSWebService/YKBPaymentService"
//document.Form1.action="http://setmpos.ykb.com/3DSWebService/YKBPaymentService"
document.forms[0].submit();
}
}
...
<body>
    <form id="Form1" runat="server" method="post" action="">
        ...
        <div style="visibility: hidden;">
            ...
            <input name="posnetReturn" type="hidden" id="posnetReturn" value="" />
