    ...
    <%
        ...
        If Request.Form.Get("mdStatus") <> "" Then
            ...
            If OkStatus.Contains(mdstatus) Then
                ...
                sb.AppendLine("md='" & Request.Form.Get("mdStatus") & "';")
                sb.AppendLine("txstatus='" & Request.Form.Get("txstatus") & "';")
            ...
            Else
                ...
                Catch
                    ...
                    If Not ConfigurationManager.AppSettings("SendFailedPayments") = "False" Then
                        mail.SendMail(_portalSettings.Email, ToSendMail, "Ödeme Onayı Alınamadı(3D)", "Kabul Edilecek işlem sonuçları(3D): " & OkStatus & "<br/>İşlem Sonucu : " & Request.Form.Get("mdStatus") & "<br/>Banka 3D Mesajı :" & res)
                    End If
                End Try
