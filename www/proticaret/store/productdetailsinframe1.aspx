...
.yui-picker-hue-bg {-moz-outline: none; outline:0px none;
    ...
    background:url(/images/hue_bg.png) no-repeat; 
    top:4px; 
}
...
.yui-picker-swatch {  position:absolute; left:160px; top:-30px; height:20px;
    width:35px; border:1px solid #888; }
.yui-picker-websafe-swatch { position:absolute; left:304px; top:4px;
    height:24px; width:24px; border:1px solid #888; }

.yui-picker-controls { z-index: -1; position:absolute;  top: -50px; left:0px; font:1em monospace;}
...
<body style="margin: 0" onload="setFrame('<%=ProductId%>','01'); ">
            ...
            <tr>
                ...
                <td>
                    <table id="Table2" cellspacing="0" cellpadding="0" width="100%" border="0">
                        <tr valign="top">
                            <td class="cerv_middle_left_seperator middle_left_seperator">
                            </td>
                            <td id="left" runat="server" visible="false">
                            </td>
                            <td valign="top">
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr valign="top">
                                        <td id="middle_left" runat="server" visible="false">                                        
                                        </td>
 ...
 <%--   <div id="LYRImage" style="position: absolute; left: 172px; top: 81px; width: 77px;
        height: 52px; z-index: 1; color: #FF0000;">
    </div>--%>
   <%-- <div style="display: block; position: absolute; z-index: 110;" id="preview_div">
    </div>--%>
            ...
            <td>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                    <tr>
                        <td></td>
                        <td >
                            <table width="100%"  style="background-image:url(/uploads/poster/banner/cervbanner.gif);background-repeat:no-repeat; width:100%; height:63;" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <td valign="bottom">
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <% 'içerik %> <table width="740"><tr><td class="cerv_postercer_ikon_sol postercer_ikon_sol">&nbsp;</td><td><a href="/uploads/yardim1.html" class="cerv_postercer_ikon1 postercer_ikon1" target="_blank"><img src="/uploads/poster/yardim1.gif" style="border:0px;" alt="" /></a><a href="/uploads/yardim2.html"  class="cerv_postercer_ikon2 postercer_ikon2" target="_blank"><img src="/uploads/poster/yardim2.gif" style="border:0px;" alt="" /></a></td></tr></table>                                             
                                                </td>
                                                <td width="740"><br /><br />
                            ...
                            <%--<tr><td>
                              <table  border="0" align="right" cellpadding="0" cellspacing="0">
                                                       <tr>
                                                            <td>
                                                                <a href="#" onclick="Javascript:menuid=1; document.getElementById('nextMenuimg').style.display='block'; SetTab('1');">
                                                                    <img  alt="" src="/uploads/poster/images/frmbt01_o.jpg" width="100" height="40" border="0" id="Img1" /></a></td>
                                                            <td>
                                                                <a href="#" onclick="Javascript:menuid=2; document.getElementById('nextMenuimg').style.display='block'; SetTab('2');">
                                                                    <img  alt="" src="/uploads/poster/images/frmbt02.jpg" width="100" height="40" border="0" id="Img2" /></a></td>
                                                            <td>
                                                                <a href="#" onclick="Javascript:menuid=3; SetTab('3');">
                                                                    <img  alt="" src="/uploads/poster/images/frmbt03.jpg" width="100" height="40" border="0" id="Img3" /></a></td>
                                                            <td>&nbsp;</td>
                                                        </tr>
                                                    </table>
                            </td></tr>--%>
                                <tr align="center">
                                    <td>
                                        <div style="overflow: scroll; border: 1px solid #666; height: 500px; width: 230px;
                                            padding: 6px;  
                                            display: none;" id="Tab2">
                                            
                                            <table width="90%" border="0">
                                                <tr>
                                                    <td colspan="3" class="cerv_Global_Bold_Label Global_Bold_Label">
                                                        2. Çerçeve Modelini Seçiniz. <a href="javascript:var PopUpWin = window.open('/uploads/poster/documents/frame.html','','width=400,height=400,scrollbars=no,status=0,toolbar=0,resizable=1')" ><img style="border:0" alt="info" src="/uploads/poster/images/info.gif" /></a></td>
                                                </tr>
                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a style="cursor: pointer" onclick="setFrame('<%=ProductId%>','<%=dvFrames(i)("FrameCode").ToString().Trim()%>');">
                                                                            <img  alt="" src="/uploads/poster/frames/<%=dvFrames(i)("FrameCode").ToString().Trim()%>/thumbnail.gif" width="100"
                                                                                height="100"  /></a>
                                                                                <a href="javascript:var PopUpWin = window.open('../uploads/poster/frames/<%=dvFrames(i)("FrameCode").ToString().Trim()%>/detail.html','','width=780,height=800,scrollbars=yes,status=0,toolbar=0,resizable=0')" >detay</a>
                                        ...
                                        <div style="overflow: scroll; border: 1px solid #666; height: 500px; width: 230px;
                                            padding: 6px; 
                                            display: none;" id="Tab3">
                                            <table id="tblpaspartu" width="90%" border="0">
                                                <tr>
                                                    <td colspan="3" class="cerv_Global_Bold_Label Global_Bold_Label">
                                                        3. Paspartu Seçiniz. <a href="javascript:var PopUpWin = window.open('/uploads/poster/documents/paspartu.html','','width=400,height=400,scrollbars=no,status=0,toolbar=0,resizable=0')" ><img style="border:0" alt="info" src="/uploads/poster/images/info.gif" /></a></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div style="overflow: scroll; border: 1px solid #666; height: 500px; width: 230px;
                                            padding: 6px;  
                                            display: block;position:relative; " id="Tab1">
                                            <div id="divduvarrengi" align="left">
                                                <table id="tblduvarrengi" border="0">
                                                    <tr>
                                                        <td  class="cerv_Global_Bold_Label Global_Bold_Label">
                                                            1. Duvar Rengini Seçiniz. <a href="javascript:var PopUpWin = window.open('/uploads/poster/documents/wall.html','','width=400,height=400,scrollbars=no,status=0,toolbar=0,resizable=0')" ><img style="border:0" alt="info" src="/uploads/poster/images/info.gif" /></a> 
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td >
...
var picker = new YAHOO.widget.ColorPicker("container", {
	...
	showwebsafe:false,
	images: {PICKER_THUMB: "/images/picker_thumb.png",HUE_THUMB: "/images/hue_thumb.png"},
	txt:{HEX:"Renk: #"}
	});
...
function toHex(N) 
{
 ...
 return "0123456789ABCDEF".charAt((N-N%16)/16)
      + "0123456789ABCDEF".charAt(N%16);
                                ...
                                <tr align="center">
                                    <td>
                                        <a href="#" onclick="nextMenu();">
                                            <img alt="" src="/uploads/poster/images/bt_fr_next.jpg" width="173" height="20" border="0" id="nextMenuimg" /></a></td>
                                </tr>
                            </table>
                            </td>
                            </tr>
   ...
   <%-- <div id="LYRCart" style="height: 1px; width: 1px; display: block;">
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr valign="top">
                                        ...
                                        <td id="bottom_center" runat="server" >
                            ...
                            <td class="cerv_middle_right_seperator middle_right_seperator">
                            </td>
        ...
        <table id="xxy" cellspacing="0" cellpadding="0" border="0">
            <tr>
                <td class="cerv_leftfooter_seperator leftfooter_seperator">
                </td>
                <td>
                    
                </td>
                <td class="cerv_rightfooter_seperator rightfooter_seperator">
                </td>
            </tr>
