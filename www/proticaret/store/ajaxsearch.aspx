...
<script runat="server" type="text/VB">
    ...
    'ALTER   PROC sp_Create_ProductList
    'AS
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            Dim sqlstr As String = "select top 10 CatID,CatName,CatUrl ,ProductUrl ,SatisFiyati1,Currency1,ProductName,MarkName,Path " & _
"from ProductListLigth where 1=1 [%x%] "
