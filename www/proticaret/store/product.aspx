<%@ Page Language="vb" AutoEventWireup="false" Inherits="ASPNetPortal.productPage" ValidateRequest="false" EnableEventValidation="false" SmartNavigation="False" Codebehind="product.aspx.vb" %>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		...
		<div id="center_middle">
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td id="middle_left" runat="server" valign="top" visible="false"><a class="middleLeftButton"></a></td>
