<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="myeditpayment.aspx.vb" Inherits="ASPNetPortal.myeditpayment" %>
                        ...
                        <div class="row">
                            <div class="colTwo">
                                ...
                                <label class="labelInput">
                                    <asp:Label ID="PaymentDate" runat="server"></asp:Label></label>
                            </div>
                            <div class="colTwo">
                                <label><%=GetGlobalResourceObject("admin", "PaymentNumber")%> :</label>
                                <label class="labelInput">
                                    <asp:Label ID="PaymentId" runat="server"></asp:Label></label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="colTwo colBtn">
                                ...
                                <label class="labelInput">
                                    <asp:HyperLink ID="FullName" runat="server"></asp:HyperLink></label> 
                            </div>
                            <div class="colTwo">
                                <label><%=GetGlobalResourceObject("admin", "PaymentMethod")%> :</label>
                                <label class="labelInput">
                                    <asp:Label ID="PaymentType" runat="server"></asp:Label></label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="colTwo">
                                ...
                                <label class="labelInput">
                                    <asp:Label ID="BankName" runat="server"></asp:Label></label>
                            </div>
                            <div class="colTwo">
                                <label><%=GetGlobalResourceObject("admin", "BankPaymentMethod")%> :</label>
                                <label class="labelInput">
                                    <asp:Label ID="BankPayType" runat="server"></asp:Label></label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="colTwo">
                                ...
                                <label class="labelInput">
                                    <asp:Label ID="Taksit" runat="server"></asp:Label></label>
                            </div>
                            <div class="colTwo">
                                <label><%=GetGlobalResourceObject("admin", "TotalAmount")%> :</label>
                                <label class="labelInput">
                                    <asp:Label ID="ToplamTutar" runat="server"></asp:Label></label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="colTwo">
                                ...
                                <label class="labelInput">
                                    <asp:Label ID="ToplamGider" runat="server"></asp:Label></label>
                            </div>
                            <div class="colTwo">
                                <label><%=GetGlobalResourceObject("admin", "TotalAmountPaid")%> :</label>
                                <label class="labelInput">
                                    <asp:Label ID="BankaToplamTutar" runat="server"></asp:Label></label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="colOne">
