        ...
        Do While dr.Read()
            ...
            If dr("Parent") = 0 Then
                ...
                If dr("ChildCount") > 0 Then
                        li.InnerHtml = String.Format("<a href=""{1}""><span>{0}</span></a><a href=""{2}.aspx""><img title=""{5}"" src=""{4}"" />{3}</a>", catName, catLink, urlbase & dr("Url").ToString.Remove(dr("Url").ToString.Length - 1, 1), dr("CatName"), urlbase & dr("CatImg"), dr("CatName"))
                Else
                        li.InnerHtml = String.Format("<a href=""{1}"">{0}</a><a href=""{2}.aspx""><img title=""{5}"" src=""{4}"" />{3}</a>", catName, catLink, urlbase & dr("Url").ToString.Remove(dr("Url").ToString.Length - 1, 1), dr("CatName"), urlbase & dr("CatImg"), dr("CatName"))
                End If
