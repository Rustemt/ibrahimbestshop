...
<script language="VB" runat="server">	
    ...
    <ScriptMethod()> _
  <WebMethod()> Public Function GetProducts(ByVal CatId As String, MarkId As String, TypeID As String, PriceID As String, Size0 As String, Size1 As String, Size2 As String, OrderBy As String, OnlyStock As Integer, ByVal pageIndex As Integer) As String
