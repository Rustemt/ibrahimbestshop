<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="cart.ascx.vb" Inherits="ASPNetPortal.cartbayi" %>
                                                        ...
                                                        <asp:DataGrid ID="DataGrid0" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="4" DataKeyField="Qty" CssClass="datalist" GridLines="none">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Birim Fiyat">
                                                                    <ItemTemplate>
                                                                        <%--<asp:Label ID="Label9" runat="server" NAME="Label9" Text='<%# FormatCurTL(CalcRate(CalcIndirim(CalcIndirim(CalcIndirim(container.dataitem("BayiFiyati")+ container.dataitem("ValueAdd"),tmpOrder.Campain.DiscountAmount,tmpOrder.Campain.DiscountType,ToplamTutar,container.dataitem("qty"),ProductLines,tmpOrder.Campain.ProductDiscountType,tmpOrder.Campain.ProductDiscountAmount,iif((container.dataitem("ProductID")= tmpOrder.Campain.ProductId and tmpOrder.Campain.DiscountType=2),true,false)) ,container.dataitem("Indirim")),UserIndirim),container.dataitem("Rate")))  %>'></asp:Label>--%>
                                                                ...
                                                                <asp:TemplateColumn HeaderText="isk3">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <%-- <asp:Label ID="lblisk3" runat="server" Text='<%# formatNumberEx(CalcIndirimRate(CalcRate(container.dataitem("BayiFiyati") + container.dataitem("ValueAdd"), container.dataitem("Rate")),tmpOrder.Campain.DiscountAmount,tmpOrder.Campain.DiscountType,ToplamTutar,container.dataitem("qty"),ProductLines,tmpOrder.Campain.ProductDiscountType,tmpOrder.Campain.ProductDiscountAmount,iif((container.dataitem("ProductID")= tmpOrder.Campain.ProductId and tmpOrder.Campain.DiscountType=2),true,false)))  %>'>
                                                                        </asp:Label>--%>
                                                                    </ItemTemplate>
                                                                </asp:TemplateColumn>
                        ...
                        <td align="right">
                            ...
                            <table cellpadding="0">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnAddOffer" runat="server" Text="Teklif İste" CssClass="buybutton" />
