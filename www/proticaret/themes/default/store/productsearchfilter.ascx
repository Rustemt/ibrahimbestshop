...
<div id="productsearchfilter" class="module">
        ...
        <div>
            <table cellspacing="0" cellpadding="3" width="100%" border="0">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlMarks" runat="server"></asp:DropDownList></td>
                </tr>
                <tr>
	...
	<asp:Label ID="Label7" runat="server"><%=GetGlobalResourceObject("lang", "Between")%></asp:Label>
                ...
                <tr>
                    <td></td>
                    <td align="left">
                        <asp:HyperLink ID="lnkWord" CssClass="searchbutton" runat="server" NavigateUrl="javascript:SearchFilter();"><%=GetGlobalResourceObject("lang", "Search")%></asp:HyperLink></td>
                </tr>
            </table>
        </div>
    </div>
