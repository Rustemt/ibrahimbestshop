                ...
                <asp:DataGrid ID="Datagrid1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="<%$ Resources:lang, QtyPrice%>" Visible="false">
                            ...
                            <ItemTemplate>
                                <label>
                                    <asp:Label ID="lblDoviz" runat="server" Text='<%# CurrencySymbolLeft & " " &  FormatCurDoviz(CalcIndirim(CalcIndirim(container.dataitem("SatisFiyati") ,container.dataitem("BirimIndirimOrani")),container.dataitem("CariIndirimOrani")) / CurrencyRate)  & " " & container.dataitem("Pb1Name")   & " " & CurrencySymbolRight %>'></asp:Label></label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
