    ...
    <div id="module_content">
        ...
        <div>
            <div id="ProductList" runat="server">
                <div id="info" runat="server" class="information"><%=GetGlobalResourceObject("lang", "CompareMsg1")%></div>
                ...
                <asp:DataGrid ID="MyList" runat="server" AutoGenerateColumns="False" CellPadding="4" Width="100%" CssClass="datalist" HeaderStyle-CssClass="title" GridLines="none" ItemStyle-CssClass="row">
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="<%$ Resources:lang, Selection%>">
                            ...
                            <ItemTemplate>
                                <center>
<asp:CheckBox ID="Compare" runat="server"></asp:CheckBox>
                                </center>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="<%$ Resources:lang, ProductCode%>" Visible="False">
                            ...
                            <ItemTemplate>
                                <asp:HyperLink ID="Hyperlink2" runat="server" Text='<%# container.dataitem("ProductCode")  %>' NavigateUrl='<%# string.format(BaseUrl & "{0}" & ".aspx",container.dataitem("ProductUrl").tostring.Remove(container.dataitem("ProductUrl").tostring.Length - 1, 1))  %>'>
                                </asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="Center" HeaderText="<%$ Resources:lang, Delete%>">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkbtnDelete" runat="server" Text="Sil" CausesValidation="false" CommandName="Delete"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                    </Columns>
            ...
            <asp:LinkButton ID="btnCompare" CssClass="button" runat="server"><%=GetGlobalResourceObject("lang", "Compare")%></asp:LinkButton>
