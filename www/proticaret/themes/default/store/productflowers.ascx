        ...
        <div id="TblUrunDetayModul" runat="server" class="TblUrunDetayModul">
            ...
            <div id="right">
                ...
                <div id="receiver" class="receiver" runat="server">
                    <div id="title">Alýcý Bilgileri</div>
                    <div id="receiverLeft">
                        <div>
        ...
        <div id="senderMessageContainer">
            <div id="sender">
                ...
                <table>
                    <tr>
                        <td align="right">
                            <asp:DropDownList ID="ddlBillCountry" runat="server">
                            </asp:DropDownList></td>
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ControlToValidate="ddlBillCountry"
                                ErrorMessage="Lütfen Ülke seçiniz" InitialValue="">*</asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <cc2:RequiredFieldValidator ID="rfvCity" runat="server" ControlToValidate="ddlCity" ErrorMessage="<%$ Resources:lang, RegisterMsg16%>" InitialValue="">*</cc2:RequiredFieldValidator></td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <%--<asp:RequiredFieldValidator ID="rvfDistrict" runat="server" ControlToValidate="ddlDistrict" ErrorMessage="ÝlçeSeçiniz..." InitialValue="--Ýlçe Seçiniz--"></asp:RequiredFieldValidator>--%></td>
                    </tr>
                    <tr>
                        <td style="display: none;">
            ...
            <div id="message" runat="server" class="message">
                <div id="messageTitle">
                    <asp:Label ID="lbltitle" runat="server" Text="KART MESAJI VE KART SEÇÝMÝ" Font-Bold="True" Font-Size="Small"></asp:Label>
                </div>
                <div class="clear"></div>
                <div id="messageInputContainer">
                    <div id="messageName">
                        <label>Karta Yazýlacak Ýsim</label>
                    </div>
                    <div id="messageInput">
                        <asp:TextBox ID="txtCartName" runat="server" MaxLength="20"></asp:TextBox>
                    </div>
                    <div id="messagecheck">
                        <asp:CheckBox ID="chkIsName" runat="server" Text="Kartta Ýsmim Görünmesin" />
                    </div>
                    <div id="messageName">
                        <label>Kart Mesajý :</label>
                    </div>
                    <div id="messageInput">
