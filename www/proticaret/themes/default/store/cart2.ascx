                                            ...
                                            <asp:DataGrid ID="dgWholelist" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="4" CssClass="datalist" HeaderStyle-CssClass="title" GridLines="none" ItemStyle-CssClass="row">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="Beden Adet">
                                                        <ItemTemplate>
                                                            <itemstyle wrap="False"></itemstyle>
                                                            <asp:Repeater runat="server" ID="rptSizeQty" OnItemDataBound="rptSizeQty_OnItemDataBound" EnableViewState="true">
                                                                <ItemTemplate>
                                                    ...
                                                    <asp:BoundColumn DataField="Qty" HeaderText="Adet"></asp:BoundColumn>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="<%$ Resources:lang, PiceWithoutTax%>">
                                                      ...
                                                      <asp:TemplateColumn HeaderText="">
                                                        ...
                                                        <ItemTemplate>
                                                            <center>
                                                                <asp:LinkButton ID="lnkUpdate" runat="server" CausesValidation="False" CssClass="button" CommandName="Update" Text="Güncelle"></asp:LinkButton>
