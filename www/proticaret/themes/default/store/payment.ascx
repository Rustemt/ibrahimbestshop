    ...
    <div id="module_content">
        ...
        <div>
            ...
            <div class="module_box">
                ...
                <asp:DataGrid ID="dgTaksitList" CellPadding="3" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="datalist" HeaderStyle-CssClass="title" GridLines="none" ItemStyle-CssClass="row">
                    <Columns>
            ...
            <label><b><%=GetGlobalResourceObject("lang", "PaymentInformation")%></b></label>
            <div class="module_box">
            ...
            <label><b><%=GetGlobalResourceObject("lang", "CreditCardInformation")%></b></label>
            <div class="module_box">
		...
		<asp:DropDownList ID="ddlYear" runat="server">
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                ...
                                <asp:Button ID="btnkuveyt" runat="server" Text="<%$ Resources:lang, MakePayment%>" CssClass="button" Visible="false" />
            ...
            <asp:Panel ID="Panel1" Style='display: none;' Width="800" Height="600" runat="server" CssClass="modalPopup3d">
                <iframe name="frame3d" id="frame3d" style="height: 550px; width: 750px" src='<%= PostUrl %>'>'  >
Tarayýcýnýz sayfa içi çerçeveleri desteklemiyor veya þu anda sayfa içi çerçeveleri göstermek için yapýlandýrýlmamýþ
                </iframe>
