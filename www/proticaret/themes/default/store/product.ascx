<%@ Control Language="vb" AutoEventWireup="false" Inherits="ASPNetPortal.product" CodeBehind="product.ascx.vb" %>
    ...
    <div id="module_content">
        ...
        <div>
            ...
            <div id="TblUrunDetayModul" runat="server" class="TblUrunDetayModul">
                                ...
                                <td>
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="www" ErrorMessage="Lütfen Maðaza Seçiniz" ControlToValidate="rdbstorages" runat="server">*</asp:RequiredFieldValidator>
                                            <div style="display: none;">
                                                <%--<div style="display: <% = IIf(enableprice=False ,"none","block") %>;">--%>
                                                <table id="FiyatPanel" cellspacing="0" cellpadding="5" width="100%" border="0">
                                                    ...
                                                    <%-- <p >
                                                        ...
                                                        <asp:Label ID="Label8" runat="server"><%=formatCurDoviz(PiyasaFiyati) + " " +CurrencyP  + GetGlobalResourceObject("lang", "PlusTax")%></asp:Label>
                                                    </p>

                                                    <p >
                                                        <asp:Label ID="lblFiyat3" runat="server">Satýþ Fiyatý3=</asp:Label>
                                                        <asp:Label ID="lblFiyat3b" runat="server"><%=formatCurDoviz(SatisFiyati3) + " " + Currency3 + GetGlobalResourceObject("lang", "PlusTax")%></asp:Label>
                                                    </p>

                                                    <p>
                                                        <asp:Label ID="lblFiyat2" runat="server">Satýþ Fiyatý2=</asp:Label>
                                                        <asp:Label ID="lblFiyat2b" runat="server"><%=formatCurDoviz(SatisFiyati2) + " " + Currency2 + GetGlobalResourceObject("lang", "PlusTax")%></asp:Label>
                                                    </p>

                                                    <p>
                                                        <asp:Label ID="lblFiyat1" runat="server">Satýþ Fiyatý1=</asp:Label>
                                                        <asp:Label ID="lblFiyat1b" runat="server"><%=formatCurDoviz(SatisFiyati1) + " " + Currency1 + GetGlobalResourceObject("lang", "PlusTax")%></asp:Label>
                                                    </p>

                                                    <p>
                                                        <asp:Label ID="lblFiyatH" runat="server">Havale Fiyatý</asp:Label>
                                                        <asp:Label ID="lblFiyatbH" runat="server"><%=formatCurDoviz(SatisFiyati0 ) + " " + Currency0 + GetGlobalResourceObject("lang", "PlusTax")%></asp:Label>
                                                    </p>--%>
                                                    ...
                                                    <%--  <p>
                                                        ...
                                                        <p >
                                                            ...
                                                            <asp:Label ID="lblFiyat3Kdvb" runat="server"><%=formatCurTL(CalcKdvDahil(SatisFiyati3 * Rate3, KdvRate))%></asp:Label>
                                                        </p>

                                                        <p >
                                                            <asp:Label ID="lblFiyat2Kdv" runat="server">Kdv Dahil Satýþ Fiyatý2=</asp:Label>
                                                            <asp:Label ID="lblFiyat2Kdvb" runat="server"><%=formatCurTL(CalcKdvDahil(SatisFiyati2 * Rate2, KdvRate))%></asp:Label>
                                                        </p>

                                                        <p>
                                                            <asp:Label ID="lblFiyat1Kdv" runat="server">Kdv Dahil Satýþ Fiyatý1=</asp:Label>
                                                            <asp:Label ID="lblFiyat1Kdvb" runat="server"><%=formatCurTL(CalcKdvDahil(SatisFiyati1 * Rate1, KdvRate))%></asp:Label>
                                                        </p>

                                                        <p >
                                                            <asp:Label ID="lblFiyatHKdv" runat="server">Kdv Dahil Havale Fiyatý=</asp:Label>
                                                            <asp:Label ID="lblFiyatHKdvb" runat="server"><%=formatCurTL(CalcKdvDahil(SatisFiyati0 * RateP, KdvRate))%></asp:Label>
                                                        </p>

                                                        <p>
                                                            <asp:Label ID="lblTaksitliFiyatiLabel" runat="server">Taksitli Fiyatý=</asp:Label>
                                                            <asp:Label ID="lblTaksitliFiyati" runat="server"><%= formatCurTL(CalcKdvDahil(CalcKdvDahil(CalcIndirim(CalcIndirim(SatisFiyati * RateP,Indirim),UserIndirim),KdvRate), CreditCardMinRate)/iif(CreditCardMaxTaksit>0,CreditCardMaxTaksit,1)) %></asp:Label>
                                                        </p>--%>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td align="right">
                                                            <asp:Label ID="lblPuant" runat="server"><%=CurrencySymbolLeft & " " & formatCurDoviz((CalcRate(SatisFiyati*Rate, _portalsettings.PointsValue))/CurrencyRate) & "  " & CurrencySymbolRight%></asp:Label></td>
                                                        <td><%=GetGlobalResourceObject("lang", "PlusTax")%></td>
                                                    </tr>
                                                    <%End If%>
                                                    <tr>
                                            ...
                                            <div class="fiyat_listesi_kullanmayanlar_icin">
                                                <table id="FiyatPanel" cellspacing="0" cellpadding="5" width="100%" border="0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label4" runat="server"><%=GetGlobalResourceObject("lang", "PriceMarket")%></asp:Label></td>
                                                        <td>:</td>
                                                        <td align="right">
                                                            <asp:Label ID="Label6" runat="server"><%= CurrencySymbolLeft & " " &  formatCurDoviz(PiyasaFiyati * RateP / CurrencyRate) & "  " & CurrencySymbolRight%></asp:Label>
                                                        </td>
                                                        <td><%=GetGlobalResourceObject("lang", "PlusTax")%></td>
                                                    </tr>
                                                    <% End If%>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label8" runat="server"><%=GetGlobalResourceObject("lang", "Point")%></asp:Label></td>
                                                        <td>:</td>
                                                        <td align="right">
                                                            <asp:Label ID="Label9" runat="server"><%=CurrencySymbolLeft & " " & formatCurDoviz((CalcRate(Bayifiyati , _portalsettings.PointsValue))/CurrencyRate) & "  " & CurrencySymbolRight%></asp:Label></td>
                                                        <td><%=GetGlobalResourceObject("lang", "PlusTax")%></td>
                                                    </tr>
                                                    <%End If%>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label13" runat="server"><%=IIf(StokIskActive Or UserIndirim > 0 Or StokIsk > 1, GetGlobalResourceObject("lang", "PriceForYou"), GetGlobalResourceObject("lang", "Price"))%></asp:Label></td>
                                                        <td>:</td>
                                                        <td align="right">
                                                            <asp:Label ID="Label14" runat="server"><%=CurrencySymbolLeft & " " &   formatCurDoviz(MainBayi) & "  " & CurrencySymbolRight%></asp:Label>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                    <%If (TransferDiscount > 0 Or (TransferPrice > 0 And Rate > 0)) Then%>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label16" runat="server"><%=GetGlobalResourceObject("lang", "PriceTrasfer")%></asp:Label></td>
                                                        <td>:</td>
                                                        <td align="right">
                                                            <asp:Label ID="Label18" runat="server"><%= CurrencySymbolLeft & " " & formatCurDoviz(TransferPrice) & "  " & CurrencySymbolRight%></asp:Label>
                                                        </td>
                                                        <td>
                                                            <b>
                                                                <asp:Label ID="Label19" runat="server">% <%=formatCurDoviz(TransferDisCount)%></asp:Label>
                                                                <asp:Label ID="Label20" runat="server">&nbsp;<%=GetGlobalResourceObject("lang", "Discount")%></asp:Label>
                                                            </b>
                                                        </td>
                                                    </tr>
                                                    <% End If%>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label21" runat="server"><%=GetGlobalResourceObject("lang", "PriceCreditCard")%></asp:Label></td>
                                                        <td>:</td>
                                                        <td align="right">
                                                            <asp:Label ID="Label22" runat="server"><%=CurrencySymbolLeft & " " & formatNumberEx(CreditCardPrice)& "  " & CurrencySymbolRight%></asp:Label>
                                                            <asp:Label ID="Label23" Visible="false" runat="server"> TL</asp:Label>
                                                        </td>
                                                        <td>
                                                            <b>
                                                                <asp:Label ID="Label24" runat="server">% <%=formatNumberEx(CreditCardDisCount)%></asp:Label>
                                                                <asp:Label ID="Label25" runat="server">&nbsp;<%=GetGlobalResourceObject("lang", "Discount")%></asp:Label>
                                                            </b>
                                                        </td>
                                                    </tr>
                                                    <% End If%>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label26" runat="server"><%=GetGlobalResourceObject("lang", "PriceCreditInstalment")%></asp:Label></td>
                                                        <td>:</td>
                                                        <td align="right">
                                                        ...
                                                        <td>
                                                            <b>
                                                                <span><%=GetGlobalResourceObject("lang", "InstalmentCount")%></span>
                                                                <asp:Label ID="Label28" runat="server">&nbsp;<%=CreditCardMaxTaksit%></asp:Label>
                                                            </b>
                                                        </td>
                                                    </tr>
                                                    <% End If%>
                ...
                <div id="right">
                	<%If (IsBulk) Then%>
                        <div class="dis-grp clearFix">
                            <label class="title3">Toptan alyn indirim firsatlaryny yakalayyn</label>
                            <div class="dis-content fLeft">
                                <span><b>Miktary</b></span>
                                <span><b>Yndirim</b></span>
                                <span><b>Birim</b></span>
                            </div>
                            <asp:Panel ID="Panel3" CssClass="dis-content fLeft" runat="server">
                                <asp:Repeater ID="rptDiscountGroup" runat="server">
                                    <HeaderTemplate>
                                        <ul class="clearFix">
                                    </HeaderTemplate>
                                    <FooterTemplate>
                                    ...
                                    <ItemTemplate>
                                        <li>
                                            <span><%# Container.dataitem("StartQty") %> - <%# Container.dataitem("EndQty") %></span>
                                            <asp:Label runat="server" Text='<%# iif(container.dataitem("DiscountType")="1","% " &  Container.Dataitem("DiscountAmount") ,  CalcIndirimRate(0,formatCurDoviz(Container.Dataitem("DiscountAmount") * Rate / CurrencyRate),1,formatCurDoviz((CalcIndirim(CalcIndirim(BayiFiyati* (Rate/ CurrencyRate),Indirim),UserIndirim)) / CurrencyRate)))%>' ID="Label8" CssClass="none"></asp:Label>
                                            <%--<asp:label runat="server" Text='<%# iif(container.dataitem("DiscountType")="1","% " &  Container.Dataitem("DiscountAmount") , CurrencySymbolLeft & " " & formatCurDoviz(Container.Dataitem("DiscountAmount") * Rate / CurrencyRate) & " " & CurrencySymbolRight )%>' ID="lblDiscountType" CssClass="none"></asp:label>--%>
                                            <span><%# Container.dataitem("UnitName") %> </span>
                                        </li>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </asp:Panel>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>: 
                                            ...
                                            <asp:Label ID="lblfile" runat="server" Style="display: none" Enabled="true"></asp:Label>
                                            <asp:FileUpload ID="oFile" runat="server" size="20" EnableViewState="true" />
                    ...
                    <div class="product-quantity module_box">
                        <div id="quantity">
                            ...
                            <input id="txtQty" type="text" value="1" style="width: 20px;" onchange="SetQuantity();" />
                    ...
                    <div id="SatinalPanel" runat="server" class="SatinalPanel">
                        <ul>
                            ...
                            <li><a id="lnkAddBookmark" class="lightbox minibutton" href='<%= BaseUrl & "/store/productbookmarkpopup.aspx?ProductId=" & Request.Params("ProductId") %>'>Sýk Aldýklarýma Ekle</a></li>
                            <% Else%>
                    ...
                    <div id="share" style="text-align: center; padding: 5px;">
                        <script runat="server" type="text/VB"> 
                            'post bilgileri
                            Private AffiliateUrl As String = IIf(PortalSecurity.IsInRole("Satýþ Ortaklarý"), IIf(System.Web.HttpContext.Current.Request.RawUrl.Contains("?"), "&AffiliateId=" & GetShoppingCartId(), IIf(System.Web.HttpContext.Current.Request.RawUrl.EndsWith(".aspx"), "?AffiliateId=" & GetShoppingCartId(), "/?AffiliateId=" & GetShoppingCartId())), "")
                            ...
                            <asp:Panel ID="TabContent4" Visible="false" runat="server">
                                <asp:DataGrid ID="dgUsages" runat="server" AutoGenerateColumns="False" CellPadding="5" Width="100%" CssClass="datalist" HeaderStyle-CssClass="title" GridLines="none" ItemStyle-CssClass="row">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn ItemStyle-HorizontalAlign="Right">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="lnkAddtoCart3a" Visible='<%# iif(container.dataitem("StockQty")>0 or container.dataitem("SellNoneStock")="TRUE",True ,False ) %>' runat="server" CssClass="button" NavigateUrl='<%# "javascript:window.top.location.href=""/store/AddToCart.aspx?ProductId=" &amp; container.dataitem("ProductId") &amp; """;" %>'><%=GetGlobalResourceObject("lang", "AddToCart")%></asp:HyperLink>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                    </Columns>
                                </asp:DataGrid>
        ...
        if ($('#tblVariants').length > 0) {
            ...
            $("*[id$='cblQuestion']").each(function () {
                if ($("*[id$='cblQuestion']:eq(" + index + ") :checked").index() == 0) {
                    ...
                    desc = desc + $("*[id$='lblQuestion']:eq(" + m + ")").text() + ":" + $("*[id$='cblQuestion']:eq(" + index + ") :checked").next().text().replace(",", ".").replace("  ", " ,").replace(") ", "), ") + " "
                }
                index = index + 1;
            });
            ...
            $.colorbox({ href: '<%= BaseUrl & "/store/addtocartpopup.aspx?ProductId=" & Request.Params("ProductId") %>&Unit=' + untid + '&ProductSizeId=' + ProductSizeId + '&Qty=' + Qty + '&CartType=' + ctype + '&ValueAdd=' + VariantValue + '&Attributes=' + attr + '&Description=' + desc + '&StorageId=' + StorageId, width: "600", height: "400", iframe: true, scrolling: false, close: '<%=GetGlobalResourceObject("lang", "close") %>' });
