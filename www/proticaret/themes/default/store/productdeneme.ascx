<%@ Control Language="vb" AutoEventWireup="false" Inherits="ASPNetPortal.productdeneme" CodeBehind="productdeneme.ascx.vb" %>
                ...
                <div id="right">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>:   
                                            ...
                                            <cc1:AsyncFileUpload runat="server" ID="fu" OnUploadedComplete="ddlQuestion_SelectedIndexChanged" UploaderStyle="Traditional" UploadingBackColor="#0066CC" />
                                            <asp:ImageButton ID="imgbtn" ImageUrl="~/themes/default/images/cart-img/address-close-bg.png" runat="server" AlternateText="Remove" OnClick="ddlQuestion_SelectedIndexChanged" />
                                            <asp:Label ID="lblfu" runat="server"></asp:Label>
                    ...
                    <div class="product-quantity module_box">
                        ...
                        <div id="cart-button">
                            ...
                            <asp:Button Text="text" runat="server" ID="btntest" OnClick="ddlQuestion_SelectedIndexChanged"  />
                        </div>
                        <div class="clear"></div>
                    </div>
                    <% End If%>
...
<script type="text/javascript">
    ...
    function AddToCart() {
        ...
        if ($('#tblVariants').length > 0) {
            ...
            //alert('<%= BaseUrl & "/1store/addtocartpopup.aspx?ProductId=" & Request.Params("ProductId") %>&Unit='+ untid + '&ProductSizeId=' + ProductSizeId + '&CartType=' + ctype + '&Attributes=' + attr + '&Description=' + desc);   
            ...
            //   $.colorbox({href:'<%= BaseUrl & "/store/addtocartpopup.aspx?ProductId=" & Request.Params("ProductId") %>&Unit='+ untid + '&ProductSizeId=' + ProductSizeId + '&CartType=' + ctype,width:"600", height:"400", iframe:true,scrolling:false});
            $.colorbox({ href: '<%= BaseUrl & "/store/addtocartpopup.aspx?ProductId=" & Request.Params("ProductId") %>&Unit=' + untid + '&ProductSizeId=' + ProductSizeId + '&Qty=' + Qty + '&CartType=' + ctype + '&ValueAdd=' + VariantValue + '&Attributes=' + attr + '&Description=' + desc + '&StorageId=' + StorageId, width: "600", height: "400", iframe: true, scrolling: false, close: '<%=GetGlobalResourceObject("lang", "close") %>' });
        }
    }
