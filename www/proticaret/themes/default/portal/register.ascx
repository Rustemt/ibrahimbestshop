        ...
        <div>
            ...
            <div id="registerLeft">
                <div id="select">
                    ...
                    <% End If%>
                    <div class="clear"></div>
                    <div id="registerTitleLeft">
                        <label><%=GetGlobalResourceObject("lang", "RequiredFields")%></label>
                        <label class="subtitle"><%=GetGlobalResourceObject("lang", "RegisterType")%></label>
                ...
                <div id="individual">
                    <label class="subtitle"><%=GetGlobalResourceObject("lang", "UserInformation")%></label>
                    <div class="clear"></div>
                    <div id="left">
            ...
            <div id="register_firma_form" class="institutional" runat="server">
                <label class="subtitle"><%=GetGlobalResourceObject("lang", "RegisterCompanyInfo")%></label>
                <div id="left">
                ...
                <div class="clear">
                    ...
                    <div id="left">
                        ...
                        <ew:MaskedTextBox ID="txtFirmaFax" runat="server" Width="100px" ErrorMessage="geçersiz giriþ" Mask="9999999999999" MaxLength="14"></ew:MaskedTextBox>
                    ...
                    <div id="right">
                        ...
                        <asp:TextBox ID="txtFirmaMail" runat="server" Width="88px" MaxLength="50" ToolTip="<%$ Resources:lang,RegisterMsg24 %>"></asp:TextBox>
                    ...
                    <div id="right">
                        ...
                        <asp:TextBox ID="txtWeb" runat="server" Width="200px" MaxLength="100"></asp:TextBox>
                    </div>
                    <div class="clear"></div>
                    <div id="left">
                        <label>
