<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="productsearchresult.ascx.vb" Inherits="ASPNetPortal.facebookproductsearchresult" %>
...
<div id="homeproducts" class="module">
    ...
    <div class="moduleContent productSearchResult moduleContentCol1">
        <div id="info" runat="server" class="information title2"><asp:Label ID="lblInfo" runat="Server"></asp:Label></div>
        <div id="alert" runat="server" class="alert title2"><asp:Label ID="lblError" runat="Server"></asp:Label></div>
                            ...
                            <asp:DataList ID="dlGalery" runat="server" DataKeyField="ProductId" Width="100%" EnableViewState="False" RepeatLayout="Flow">
                                ...
                                <ItemTemplate>
                                        ...
                                        <div class="productImage">
                                            <a href='<%# string.format(BaseUrl & "/facebook/product.aspx?ProductId={0}&CatId={1}",container.dataitem("ProductId").tostring,container.dataitem("CatId")) & iif(Request.QueryString.Item("tabId")="","","&tabId=" & Request.QueryString.Item("tabId")) %>'>
                                                <asp:Image ID="Image1q" runat="server" BorderStyle="None" AlternateText='<%# container.dataitem("ProductName") %>' ToolTip='<%# container.dataitem("ProductName") %>' ImageUrl='<%# BaseUrl & "/facebook/makethumb.aspx?file=" + container.dataitem("Path") & "&intSize=" & 160 %>'></asp:Image>
                                            </a>
                                        </div>
                                        ...
                                        <div class="productPrice">
                                            ...
                                            <asp:Label ID="Label37" runat="server" Text='<%# CurrencySymbolLeft & " " &  formatCurDoviz(CalcKdvDahil(CalcIndirim(CalcIndirim(container.dataitem("SatisFiyati")* (container.dataitem("Rate") / CurrencyRate),container.dataitem("Indirim")),UserIndirim),container.dataitem("KdvRate")))  & " " & CurrencySymbolRight  %>'>
                                                            </asp:Label>
                                        </div>
