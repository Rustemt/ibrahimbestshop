<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="orderstep2.ascx.vb" Inherits="ASPNetPortal.facebook_orderstep2" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                <ContentTemplate>
                    ...
                    <cc3:CascadingDropDown ID="CascadingDropDown2" runat="server" TargetControlID="ddlBillCity"
                        ParentControlID="ddlBillCountry" Category="CityId" PromptText="-Şehir Seçiniz-" ServicePath="/services/city.asmx"
                        ServiceMethod="GetCity" />
                    <cc3:CascadingDropDown ID="CascadingDropDown3" runat="server" TargetControlID="ddlBillDistrict"
                        ParentControlID="ddlBillCity" Category="DistrictId" PromptValue="0" PromptText="-İlçe Seçiniz-" ServicePath="/services/city.asmx"
                    ...
                    <cc3:CascadingDropDown ID="CascadingDropDown5" runat="server" TargetControlID="ddlShipCity"
                        ParentControlID="ddlShipCountry" Category="CityId" PromptText="-Şehir Seçiniz-" ServicePath="/services/city.asmx"
                        ServiceMethod="GetCity" />
                    <cc3:CascadingDropDown ID="CascadingDropDown6" runat="server" TargetControlID="ddlShipDistrict"
                        ParentControlID="ddlShipCity" Category="DistrictId" PromptValue="0" PromptText="-İlçe Seçiniz-" ServicePath="/services/city.asmx"
                        ServiceMethod="GetDistict" />
                        <div class="moduleContentCol2 radius5">
                            ...
                            <div class="moduleCol1">
                                ...
                                <ew:MaskedTextBox ID="txtBillPhoneNo" runat="server" ErrorMessage="geçersiz giriş" Mask="9999999999999" ErrorText="*" MaxLength="14"></ew:MaskedTextBox>
                            ...
                            <div class="moduleCol1">
                                ...
                                <ew:MaskedTextBox ID="txtBillGSMno" runat="server" ErrorMessage="geçersiz giriş" Mask="9999999999999" ErrorText="*" MaxLength="14"></ew:MaskedTextBox>
                            </div>
                            <div class="moduleCol1">
                        ...
                        <div class="moduleContentCol2 radius5">
                            ...
                            <div id="tblShipping" style="display:none;">
                                ...
                                <div class="moduleCol1">
                                    <label>* <%=GetGlobalResourceObject("lang", "Phone")%> :</label>
                                    <ew:MaskedTextBox ID="txtPhoneNo" runat="server" ErrorMessage="geçersiz giriş" Mask="9999999999999" ErrorText="*" MaxLength="14"></ew:MaskedTextBox>
                                ...
                                <div class="moduleCol1">
                                    <label><%=GetGlobalResourceObject("lang", "PhoneGsm")%> :</label>
                                    <ew:MaskedTextBox ID="txtGSMno" runat="server" ErrorMessage="geçersiz giriş" Mask="9999999999999" ErrorText="*" MaxLength="14"></ew:MaskedTextBox>
                                </div>
                                <div class="moduleCol1">
                                    <label>* Ülke :</label>
