<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="orderstep3d.ascx.vb" Inherits="ASPNetPortal.facebookorderstep3d" %>
        ...
        <div id="mainPanel" runat="server">
            ...
            <div class="module_box">
                ...
                <asp:DataGrid ID="MyList" runat="server" Width="100%" AutoGenerateColumns="False"
                    DataKeyField="Qty" ShowFooter="False" CellPadding="4" CssClass="datalist basketOrder" HeaderStyle-CssClass="title"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn Visible="false" HeaderText="D&#246;viz Tutar">
                            ...
                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label ID="lblDoviz" runat="server" Text='<%# CurrencySymbolLeft & " " &  FormatCurDoviz(CalcIndirim(CalcIndirim(CalcIndirim(container.dataitem("SatisFiyati")+ container.dataitem("ValueAdd"),tmpOrder.Campain.DiscountAmount,tmpOrder.Campain.DiscountType,ToplamTutar,container.dataitem("qty"),ProductLines,tmpOrder.Campain.ProductDiscountType,tmpOrder.Campain.ProductDiscountAmount,iif((container.dataitem("ProductId")= tmpOrder.Campain.ProductId and tmpOrder.Campain.DiscountType=2),true,false)) ,container.dataitem("Indirim")),UserIndirim) )  & " " & CurrencySymbolRight %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn Visible="False" HeaderText="Birim Fiyat(KDV)">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%# FormatCurTL(CalcKdvDahil(CalcRate(Container.DataItem("SatisFiyati")+ container.dataitem("ValueAdd"),container.dataitem("Rate")),container.dataitem("KdvRate")))  %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn Visible="False" HeaderText="İndirim(KDV)">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label ID="Label13" runat="server" Text='<%# CurrencySymbolLeft & " " & formatCurDoviz(CalcKdvDahil(CalcRate(Container.DataItem("SatisFiyati")+ container.dataitem("ValueAdd"),container.dataitem("Rate")),container.dataitem("KdvRate"))-CalcKdvDahil(CalcIndirim(CalcIndirim(CalcRate(container.dataitem("SatisFiyati") , container.dataitem("Rate")/ CurrencyRate),container.dataitem("Indirim")),UserIndirim),container.dataitem("KdvRate")))  & " " & CurrencySymbolRight %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn Visible="False" HeaderText="İndirim">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label ID="indirim" runat="server" Text='<%# CurrencySymbolLeft & " " & formatCurDoviz(CalcRate(Container.DataItem("SatisFiyati")+ container.dataitem("ValueAdd"),container.dataitem("Rate"))- CalcIndirim(CalcIndirim(CalcRate(container.dataitem("SatisFiyati") , container.dataitem("Rate")/ CurrencyRate),container.dataitem("Indirim")),UserIndirim))  & " " & CurrencySymbolRight %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn Visible="False" HeaderText="Tutar(KDV)">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label ID="Label14" runat="server" Text='<%# CurrencySymbolLeft & " " & formatCurDoviz(CalcKdvDahil(CalcIndirim(CalcIndirim(CalcRate(container.dataitem("SatisFiyati")+ container.dataitem("ValueAdd") , container.dataitem("Rate")/ CurrencyRate),container.dataitem("Indirim")),UserIndirim),container.dataitem("KdvRate"))* container.dataitem("qty"))  & " " & CurrencySymbolRight %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
            ...
            <div class="moduleCol1">
                    <div id="pnlKreditKartBanner" class="paymentContent" runat="server">
                        <div id="Div1">
                            <label>
                                <span id="Span1"></span>
                                <cc1:GroupRadioButton ID="rbKK" runat="server" AutoPostBack="True" CommandName="0" CommandArgument="0" GroupName="paytype"></cc1:GroupRadioButton>
                    ...
                    <div id="pnlKreditCart" runat="server">
                        <div id="posalert" visible="false" runat="server" class="title2"><asp:Label ID="lblPosError" runat="server"></asp:Label></div>
                        <table cellpadding="5" cellspacing="5">
                            <tr>
                                <td><asp:Label ID="Label35" runat="server"><%=GetGlobalResourceObject("lang", "CreditCardName")%></asp:Label></td>
                                <td>:
                                    <asp:TextBox ID="txtName" runat="server" CssClass="keyboardInput"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtName" ErrorMessage="Lütfen Kart Üzerindeki İsimi giriniz.">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td><asp:Label ID="Label36" runat="server"><%=GetGlobalResourceObject("lang", "CreditCardNumber")%></asp:Label></td>
                                <td>:
                                    <asp:TextBox ID="txtKKNumber" runat="server" CssClass="keyboardInput" MaxLength="16"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtKKNumber" ErrorMessage="Lütfen Kart Numarasını giriniz.">*</asp:RequiredFieldValidator>
                            ...
                            <tr>
                                <td><asp:Label ID="Label38" runat="server" Width="128px"><%=GetGlobalResourceObject("lang", "CreditCardExDate")%></asp:Label></td>
                                <td>:
                            ...
                            <tr>
                                <td><asp:Label ID="Label39" runat="server"><%=GetGlobalResourceObject("lang", "CreditCardSecurityNumber")%></asp:Label></td>
                                <td>:
                                    ...
                                    <a href='/uploads/documents/cvc2.html' class="lightbox"><%=GetGlobalResourceObject("lang", "CreditCardSecurityNumberDesc")%></a>
                                </td>
                            </tr>
                            <tr>
                                <td><asp:Label ID="Label8" runat="server"><%=GetGlobalResourceObject("lang", "SelectBank")%></asp:Label></td>
                                <td>:
                            ...
                            <tr>
                                <td colspan="2"><asp:Label ID="lblBankDetails" runat="server"></asp:Label></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <table border="0" cellpadding="1" cellspacing="0" id="pnlKKOdemeList" runat="server">
                                        <tr>
                                            <td colspan="3"><asp:Label ID="Label10" runat="server"><%=GetGlobalResourceObject("lang", "CreditCardPaymentOptions")%></asp:Label></td>
                                        </tr>
                                        <tr id="trRbTekcekim" runat="server">
                                            <td> <cc1:GroupRadioButton ID="rbTekCekim" runat="server" AutoPostBack="True" Checked="True" CommandName="0" CommandArgument="0" GroupName="TaksitSayisi"></cc1:GroupRadioButton></td>
                                            <td> <asp:Label ID="Label9" runat="server">Tek Çekim</asp:Label></td>
                                            <td> <asp:Label ID="lblTekCekimTutar" runat="server"></asp:Label></td>
                                        </tr>
                                        <tr id="trRbPuan" runat="server">
                                            <td><cc1:GroupRadioButton ID="rbPuan" runat="server" AutoPostBack="True" CommandName="0" CommandArgument="0" GroupName="TaksitSayisi"></cc1:GroupRadioButton></td>
                                            <td><asp:Label ID="lblPuan" runat="server">Puan Kullan</asp:Label></td>
                                            <td><asp:Label ID="lblPuanTutar" runat="server"></asp:Label></td>
                                        </tr>
            ...
            <div class="moduleCol1" style='display: <%= iif(pnlHavaleBanner.visible,"","none") %>'>
                    <div id="pnlHavaleBanner" class="paymentContent" runat="server">
                        <div id="Div2">
                            <label>
                                <span id="Span2"></span>
                                <cc1:GroupRadioButton ID="rbTR" runat="server" AutoPostBack="True" CommandName="0" CommandArgument="0" GroupName="paytype"></cc1:GroupRadioButton>
                    ...
                    <div id="pnlHavale" runat="server">
                        <label><asp:Label ID="lblBankTransfer" runat="server"></asp:Label></label>
                        <label><asp:Label ID="lblBankaSec" runat="server"><%=GetGlobalResourceObject("lang", "SelectBank")%> :</asp:Label></label>
                        <asp:DropDownList ID="ddlTrasferBanks" runat="server"><asp:ListItem Selected="True" Value="0" Text="<%$ Resources:lang, SelectValue%>"></asp:ListItem></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="rqRegister109" runat="server" ControlToValidate="ddlTrasferBanks" ErrorMessage="Lütfen Havale Yapacağınız Bankayı Seçiniz." Font-Size="X-Small" InitialValue="0">*</asp:RequiredFieldValidator>
                        <label><asp:Label ID="lblTransferInfo" runat="server"></asp:Label></label>
                    </div>
                </div>
                
         <div class="moduleCol1" style='display: <%= iif(ConfigurationManager.AppSettings("IParaActive")="True","","none") %>'>
                <div id="pnlIparaBanner" class="paymentContent" runat="server">
                    <div id="Div3">
                        <label>
                            <span id="Span3"></span>
                            <cc1:GroupRadioButton ID="rbIp" runat="server" AutoPostBack="True" CommandName="0" CommandArgument="0" GroupName="paytype"></cc1:GroupRadioButton>
                ...
                <div id="pnlIpara" runat="server">
                    <label><asp:Label ID="lblIparaTransfer" runat="server"></asp:Label></label>
                </div>
            </div>
            <div class="moduleCol1" style='display: <%= iif(ConfigurationManager.AppSettings("PaypalActive")="True","","none") %>'>
                <div id="pnlPaypalBanner" class="paymentContent" runat="server">
                    <div id="Div4">
                        <label>
                            <span id="Span4"></span>
                            <cc1:GroupRadioButton ID="rbPaypal" runat="server" AutoPostBack="True" CommandName="0" CommandArgument="0" GroupName="paytype"></cc1:GroupRadioButton>
                            <span class="paypallogo">
                                <img src="<% =getThemePath() %>/images/bankalar/logo_paypal.png" align="absmiddle"/>
                                <asp:Label ID="lblOdemePaypal" runat="server">  &nbsp;  İle Ödeme</asp:Label>
                            </span>
                         </label>
                    </div>
                </div>
                <div id="pnlPaypal" runat="server"><label><asp:Label ID="lblPaypalTransfer" runat="server"></asp:Label></label></div>
            </div>
            <div class="moduleCol1" style='display: <%= iif(ConfigurationManager.AppSettings("PayUActive")="True","","none") %>'>
                <div id="pnlPayUBanner" class="paymentContent" runat="server">
                    <div id="Div5">
                        <label>
                            <span id="Span5"></span>
                            <cc1:GroupRadioButton ID="rbPayU" runat="server" AutoPostBack="True" CommandName="0" CommandArgument="0" GroupName="paytype"></cc1:GroupRadioButton>
                            <span class="payulogo">
                                <img src="<% =getThemePath() %>/images/bankalar/logo_payu.png" align="absmiddle"/>
                ...
                <div id="pnlPayU" runat="server">
                    <label><asp:Label ID="lblPayUTransfer" runat="server"></asp:Label></label>
                </div>
            </div>
            <div class="moduleCol1" style='display: <%= iif(ConfigurationManager.AppSettings("QapelActive")="True","","none") %>'>
                <div id="pnlQapelBanner" class="paymentContent" runat="server">
                    <div id="Div6">
                        <label>
                            <span id="Span6"></span>
                            <cc1:GroupRadioButton ID="rbQapel" runat="server" AutoPostBack="True" CommandName="0" CommandArgument="0" GroupName="paytype"></cc1:GroupRadioButton>
                            <span class="payulogo">
                                <img src="<% =getThemePath() %>/images/social/qapel.png" align="absmiddle" />
                                <asp:Label ID="Label5" runat="server"></asp:Label>
                            </span>
                         </label>
                    </div>
                </div>
                <div id="pnlQapel" runat="server">
                    <asp:Label ID="lblQapel" runat="server"></asp:Label>

                    <asp:HiddenField Value="" runat="server" ID="hf1" />
                    <asp:HiddenField Value="" runat="server" ID="hf2" />
                    <asp:HiddenField Value="" runat="server" ID="hf3" />
                    <asp:HiddenField Value="" runat="server" ID="hf4" />
                    <asp:HiddenField Value="" runat="server" ID="hf5" />
                    <asp:HiddenField runat="server" ID="QapelAcces" />
                    <asp:HiddenField runat="server" ID="QapelID" />


                    <script type="text/javascript">
                        // İstek değişkenleri
                        var partnerid = '<% = hf1.Value %>';
                        var siteid = '<% = hf2.Value %>';
                        var nonce = '<% = hf3.Value%>';
                        var timestamp = '<% = hf4.Value %>';
                        var signature = '<% = hf5.Value%>';
                    </script>

                    <script type="text/javascript" src="https://www.qapel.com.tr/api/access/qapel_login.js"></script>
                    ...
                    <script type="text/javascript">
                        ...
                        function onMessage(messageEvent) {
                            ...
                            if (messageEvent.origin == "https://" + guestDomain) {
                                if (messageEvent.data["userid"]) {
                                    userid = messageEvent.data["userid"];
                                }
                                if (messageEvent.data["accesskey"]) {
                                    accesskey = messageEvent.data["accesskey"];
                                }
                                if (messageEvent.data["vazgec"]) {
                                    vazgec = messageEvent.data["vazgec"];
                                    $('#girisoldu').html('vazgeçtiniz');
                                }
                                if (userid && accesskey) {
                                    $('#girisoldu').html("Tebrikler Qapel bağlantınızı yaptınız. Alışverişi tamamlamak için Qapel ile öde düğmesine basınız.")

                                    document.getElementById("ctl04_QapelAcces").value = accesskey;
                                    document.getElementById("ctl04_QapelID").value = userid;
                                }
                                setTimeout("$('#qapellogin').trigger('close')", 3000);
                            }
                        }
                    </script>
                    <div id="girisoldu">
                        <asp:Panel ID="qapelBtnPanel" runat="server">
                            <button type="button" onclick="$('#qapellogin').dologin();">Qapel ile bağlan</button>
                        </asp:Panel>
                    </div>
                    <label>
                        <asp:Literal ID="ltrQapelResult" runat="server"></asp:Literal></label>
                </div>
            </div>
            
            
            
            <div class="moduleCol1" style='display: <%= iif(pnlteslimattaOdeBanner.visible,"","none") %>'>
                    <div id="pnlteslimattaOdeBanner" class="paymentContent" runat="server">
                        <div id="Div7">
                            <label>
                                <span id="Span7"></span>
                                <cc1:GroupRadioButton ID="rbTO" runat="server" AutoPostBack="True" CommandName="0" CommandArgument="0" GroupName="paytype"></cc1:GroupRadioButton>
                                <asp:Label ID="lblTO" runat="server">Teslimatta Ödeme</asp:Label>
                            </label>
                        </div>
                    </div>
                    <div id="pnlteslimattaOde" runat="server">
                        <label><asp:Label ID="lblTeslimattaOde" runat="server"></asp:Label></label>
                        <label><asp:Label ID="lblTeslimattaOdeInfo" runat="server"></asp:Label></label>
                    </div>
                </div>

            <label id="pnlPaytypes" class="paymentContent pnlPaytypes" runat="server"></label>
            
            <div class="moduleCol1">
                    <div id="tblHediyeNotu" runat="server">
                        <label class="title4"><%=GetGlobalResourceObject("lang", "GiftNote")%></label>
                        <table cellpadding="10" cellspacing="10" border="0">
                            <tr>
                                <td valign="top">
                                    ...
                                    <asp:TextBox ID="txtHediyeNot" Style="display: none" runat="server" MaxLength="100" Height="80px" TextMode="MultiLine"></asp:TextBox>
                                </td>
                                <td valign="top">
                                    ...
                                    <asp:DataList ID="dlPaket" runat="server" RepeatDirection="Horizontal" RepeatColumns="6" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <p><asp:RadioButton onclick="CheckOnes(this);" ID="RadioButton2" runat="server" GroupName="paket"></asp:RadioButton></p>
            ...
            <div style="text-align: center">
                <asp:HyperLink runat="server" ID="btnPayIpara" NavigateUrl="javascript:LoadFrame()"
                    CssClass="button">İpara İle Öde</asp:HyperLink>
                <asp:HyperLink runat="server" ID="btnPaypal" NavigateUrl="javascript:LoadFrame()"
                    CssClass="button">Paypal İle Öde</asp:HyperLink>
                <asp:HyperLink runat="server" ID="btnPayU" NavigateUrl="javascript:LoadFrame()" CssClass="button">PayU ile Öde</asp:HyperLink>
                <aspzone:OneClickButton ID="OneClickButton1" runat="server" CssClass="button" Text="<%$ Resources:lang, OrderNow%>"
                    WaitText="<%$ Resources:lang, Wait%>"></aspzone:OneClickButton>
                <asp:Button ID="OneClickButton2" runat="server" Style="visibility: hidden;" Text="<%$ Resources:lang, OrderNow%>"
                    UseSubmitBehavior="false" />
                <asp:HyperLink runat="server" ID="OneClickButton3" NavigateUrl="javascript:LoadFrame()" CssClass="button">OneClickButton3</asp:HyperLink>
                ...
                <asp:Button ID="btnQapel" runat="server" Text="Qapel İle Öde" CssClass="button" />
            </div>
