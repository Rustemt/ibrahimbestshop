<%@ Control Language="vb" AutoEventWireup="false" Inherits="ASPNetPortal.facebook_product" CodeBehind="product.ascx.vb" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <div id="FiyatPanel">
                                <div class="mark">
                                    <%If MarkName <> "" Then%>
                                    <a href="<%= string.format(BaseUrl & "/marka/{0}" & ".aspx", dourl(MarkName)) %>"><%=GetGlobalResourceObject("lang", "ProductMark")%> :<%=MarkName%></a><%End If%></div>
                                ...
                                <div class="productPrice">
                                    <div class="oldPrice">
                                        <asp:Label ID="Label14" CssClass="oldPrice" runat="server"><%=formatCurTL(CalcKdvDahil(PiyasaFiyati * RateP, KdvRate))%></asp:Label>
                                    </div>
                                    <div class="price">
...
<script type="text/javascript">
    ...
    function AddToCart() {
        ...
        if ($('#tblVariants').length > 0) {
            ...
            //alert('<%= "https://" & BaseUrl.replace("http://","") & "/1store/addtocartpopup.aspx?ProductId=" & Request.Params("ProductId") %>&Unit='+ untid + '&ProductSizeId=' + ProductSizeId + '&CartType=' + ctype + '&Attributes=' + attr + '&Description=' + desc);   
            $.colorbox({ href: '<%= "https://" & BaseUrl.replace("http://","") & "/facebook/addtocartpopup.aspx?ProductId=" & Request.Params("ProductId") %>&Unit=' + untid + '&ProductSizeId=' + ProductSizeId + '&Qty=' + Qty + '&CartType=' + ctype + '&ValueAdd=' + VariantValue + '&Attributes=' + attr + '&Description=' + desc, width: "600", height: "400", iframe: true, scrolling: false, close: '<%=GetGlobalResourceObject("lang", "close") %>' });

            //'<%= "https://" & BaseUrl.replace("http://","") & "/facebook/addtocartpopup.aspx?ProductId=" & Request.Params("ProductId") %>'
            ...
            //   $.colorbox({href:'<%= "https://" & BaseUrl.replace("http://","") & "/facebook/addtocartpopup.aspx?ProductId=" & Request.Params("ProductId") %>&Unit='+ untid + '&ProductSizeId=' + ProductSizeId + '&CartType=' + ctype,width:"600", height:"400", iframe:true,scrolling:false});
            $.colorbox({ href: '<%= "https://" & BaseUrl.replace("http://","") & "/facebook/addtocartpopup.aspx?ProductId=" & Request.Params("ProductId") %>&Unit=' + untid + '&ProductSizeId=' + ProductSizeId + '&Qty=' + Qty + '&CartType=' + ctype + '&ValueAdd=' + VariantValue + '&Attributes=' + attr + '&Description=' + desc, width: "600", height: "400", iframe: true, scrolling: false, close: '<%=GetGlobalResourceObject("lang", "close") %>' });
        }
    }
