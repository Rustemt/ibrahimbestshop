    ...
    <div class="moduleContent moduleContentCol1 clearFix">
        <div id="accountMenu">
            <ul>
                ...
                <li><i class="icon-credit-card-4"></i>
                    <asp:HyperLink ID="HyperLink13" runat="server" NavigateUrl="/store/mypayment.aspx" Text="Online Ödeme Listem"></asp:HyperLink></li>
                <li><i class="icon-basket"></i>
                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="/store/orderlist.aspx">Sipariþ Listem</asp:HyperLink></li>
                <li><i class="icon-check-1"></i><a href="/store/productbookmark.aspx">Sýk Aldýklarým Listesi</a></li>
                <li runat="server" id="hypoffer"><i class="icon-chat-5"></i>
                    <asp:HyperLink ID="HyperLink17" runat="server" NavigateUrl="/store/offerlist.aspx"><%=GetGlobalResourceObject("lang", "OfferList")%></asp:HyperLink></li>
                <li class="contentMenu" runat="server" id="hypservis">
                    <i class="icon-cog-3"></i><a>Servis Islemlerim</a>
                    <ul>
                        <li>
                            <asp:HyperLink ID="hyplservis" runat="server">Yeni Servis Talebi</asp:HyperLink></li>
                        <li>
                            <asp:HyperLink ID="HyperLink15" runat="server" NavigateUrl="/store/servicelist.aspx"><%=GetGlobalResourceObject("lang", "ServiceList")%></asp:HyperLink></li>
                    </ul>
                </li>

                <li runat="server" id="linm"><i class="icon-shop-1"></i>
                    <asp:HyperLink ID="HyperLink14" runat="server" NavigateUrl="/store/nmorderlist.aspx"><%=GetGlobalResourceObject("lang", "nmOrderList")%></asp:HyperLink></li>
                <li runat="server" id="linm_member"><i class="icon-users"></i>
                    <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="/store/nmusers.aspx"><%=GetGlobalResourceObject("lang", "MarkettingMembers")%></asp:HyperLink></li>
            ...
            <ul>
                ...
                <li><i class="icon-sort-number-down"></i>
                ...
                <li>
                    <i class="icon-clipboard-1"></i> <asp:HyperLink ID="HyperLink16" runat="server" NavigateUrl="/affiliate/default.aspx"><%=GetGlobalResourceObject("lang", "Affiliate")%></asp:HyperLink></li>
                <% End If%>
                <%  If ConfigurationManager.AppSettings("SupportActive") = "True" Then%>
                <li style="display: none;">
                    <i class="icon-lifebuoy"></i> <asp:HyperLink ID="hypdestek" runat="server" NavigateUrl="/support/default.aspx">Destek Taleplerim</asp:HyperLink></li>
                <li runat="server" id="liHyperLink16">
                    <i class="icon-lifebuoy"></i> <asp:HyperLink ID="HyperLink18" runat="server" NavigateUrl="/supportfree/default.aspx">Destek Taleplerim</asp:HyperLink></li>
                <li runat="server" id="lihypinfo">
                    <i class="icon-help"></i> <asp:HyperLink ID="hypinfo" runat="server" NavigateUrl="/supportfree/default2.aspx">Bilgi Taleplerim</asp:HyperLink></li>
                <% End If%>
            </ul>
        </div>
    </div>
