...
<div id="brands" class="module">
    ...
    <div class="moduleContent moduleContentCol1">
        ...
        <asp:Repeater ID="rptbrands" runat="server">
            <HeaderTemplate><ul class="list clearFix"></HeaderTemplate>
            ...
            <img alt="img" src='<%# BaseUrl & "/store/makethumb.aspx?file=../../" + container.dataitem("Image") & "&intSize=50" %>' /> <%#Container.DataItem("MarkName")%></a></span>
            <a href='<%# String.Format(BaseUrl & "/marka/{0}" & ".aspx", doUrl(container.dataitem("MarkName"))) %>' style="display:none;"></a>
            </li>
            </ItemTemplate>
        </asp:Repeater>
    </div>
