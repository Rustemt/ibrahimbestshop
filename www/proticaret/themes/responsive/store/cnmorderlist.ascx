<%@ Control Language="vb" AutoEventWireup="false" Inherits="ASPNetPortal.cnmorderlist" CodeBehind="cnmorderlist.ascx.vb" %>
        ...
        <div class="dataTable hidden">
            <asp:DataGrid ID="Datagrid1" CellPadding="5" runat="server" Width="100%" AllowPaging="True" PageSize="20" AutoGenerateColumns="False" AllowSorting="True" CssClass="datalist" HeaderStyle-CssClass="title" GridLines="none" ItemStyle-CssClass="row">
                <Columns>
                    ...
                    <asp:BoundColumn DataField="FullName" HeaderStyle-Wrap="false" HeaderText="<%$ Resources:lang, NameAndSureName%>"></asp:BoundColumn>
                    ...
                    <asp:TemplateColumn HeaderText="<%$ Resources:lang, Details%>">
                        <ItemTemplate>
                            <a id="lnkCompare" class="lightbox button iButton" href='<%# BaseUrl & "/store/orderdetail.aspx?IND=" & DataBinder.Eval(Container.DataItem, "OrderCode") & "&MID=" & DataBinder.Eval(Container.DataItem, "CustomerId") & ""%>'>
