...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#valueSlide").html(minPrice + ", " + maxPrice);
        ...
        <div id="promenu" class="Categories">
            ...
            <div id="divTypes" visible="false" runat="server" class="moduleBox checkFilter bigCheck">
                <span style="display: none;">
                    <asp:Label CssClass="title2" ID="lblCloseTypes" Visible="false" runat="server"><b><%=GetGlobalResourceObject("lang", "FilterOnly")%></b></asp:Label></span>
...
<cc1:ModalUpdateProgress ID="mup" runat="server" DisplayAfter="0" BackgroundCssClass="modalBackground">
    <ProgressTemplate>
