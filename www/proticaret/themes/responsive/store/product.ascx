    ...
    <div class="moduleContent clearFix">
        ...
        <div id="TblUrunDetayModul" runat="server" class="TblUrunDetayModul clearFix">
                            ...
                            <div id="FiyatPanel">
                                ...
                                <div class="productPrice">
                                    <div class="oldPrice">
                                        ...
                                        <asp:Label ID="Label14" runat="server"><%=CurrencySymbolLeft & " " & formatCurDoviz( CalcKdvDahil(PiyasaFiyati * RateP, KdvRate) / CurrencyRate) & " " & CurrencySymbolRight%></asp:Label>
                                        <%End If%>
                                    </div>
                                    <div class="price">
                                        <asp:Label ID="lblMainPrice" runat="server"><%= CurrencySymbolLeft & " " & formatCurDoviz(CalcKdvDahil((CalcIndirim(CalcIndirim(BayiFiyati,Indirim),UserIndirim)) / CurrencyRate,KdvRate))  & " " & CurrencySymbolRight   %></asp:Label>
                                    </div>
                                </div>
                            </div>
                        </ContentTemplate>
            ...
            <div class="moduleContentCol2 productBuyContent">
                ...
                <%  If StockQty > 0 Or SellNoneStock Then%>
                <% If ProductSizeOptionId > 0 Then%>
                <div class="moduleBox moduleContentCol1">
                    <div id="tblvariant">
                        <div id="size0SelectorContent" class="moduleContentCol4 clearFix" style="display: none">
                            <p class="clearFix">
                        ...
                        <div id="size1SelectorContent" class="moduleContentCol4 clearFix" style="display: none">
                            <p class="clearFix">
                        ...
                        <div id="size2SelectorContent" class="moduleContentCol4 clearFix" style="display: none">
                            <p class="clearFix">
                        ...
                        <a class="moduleContentCol4" href="Javascript:var PopUpWin = window.open('/store/sizecartpopup.aspx?VariantId=<%= ProductSizeOptionId %>','','width=800,height=600,scrollbars=1,toolbar=0,status=1,resizable=1')">
        ...
        <div>
            ...
            <div class="dis-grp clearFix">
                <label class="title3">Toptan alýn indirim firsatlarýný yakalayýn</label>
                <div class="dis-content fLeft">
                    <span><b>Miktarý</b></span>
                    <span><b>Ýndirim</b></span>
                    <span><b>Birim</b></span>
                </div>
                    ...
                    <asp:Repeater ID="rptDiscountGroup" runat="server">
                        ...
                        <ItemTemplate>
                            <li>
                                ...
                                <asp:Label runat="server" Text='<%# iif(container.dataitem("DiscountType")="1","% " &  Container.Dataitem("DiscountAmount") ,  CalcIndirimRate(0,formatCurDoviz(Container.Dataitem("DiscountAmount") * Rate / CurrencyRate),1,IIf(BayiFiyati=0,1, formatCurDoviz((CalcIndirim(CalcIndirim(BayiFiyati* (Rate/ CurrencyRate),Indirim),UserIndirim)) / CurrencyRate))))%>' ID="Label8" CssClass="none"></asp:Label>
