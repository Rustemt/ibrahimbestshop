<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="productflowers.ascx.vb" Inherits="ASPNetPortal.productflowers" %>
...
<div class="flowersProductDetail" class="module">
	<% If HeaderVisible Then%>
        ...
        <% End If%>
    <div id="moduleContent clearFix">
    	<div class="moduleContent clearFix">
            <cc1:CascadingDropDown ID="CascadingDropDown1" runat="server" TargetControlID="ddlBillCountry"
                Category="CountryId" PromptText="-Ülke Seçiniz-" ServicePath="/services/city.asmx" ServiceMethod="GetCountryTurkey" />
            ...
            <cc1:CascadingDropDown ID="CascadingDropDown3" runat="server" TargetControlID="ddlDistrict"
            ...
            <div id="TblUrunDetayModul" runat="server" class="TblUrunDetayModul">
            	<div class="moduleContentCol3">
                	<div id="imageTabContainer" class="imagesConainer moduleCol1 clearFix" style='width: <%= (ImageSize+30) & "px;"%>'>
                        ...
                        <div id="tab_videos" class="s2"><asp:Label runat="server" ID="pnlvideo"></asp:Label></div>
                ...
                <div class="moduleContentCol3">
                	<div class="PriceContainer">
                        ...
                        <div class="kdvPrice">
                            ...
                            <div class="kdvInside">
                                <asp:Label ID="lblFiyat1b" runat="server"><%= CurrencySymbolLeft & " " &  formatCurDoviz(SatisFiyati1 * RateP / CurrencyRate) & "  " & CurrencySymbolRight%></asp:Label>
                                <asp:Label ID="lblFiyat1c" runat="server"></asp:Label>
                                <%=GetGlobalResourceObject("lang", "PlusTax")%>
                            </div>
                            <% End If%>
                        </div>
                        <div class="kdvIncludedPrice">
                            <span><b>Kdv Dahil :</b></span>
                        ...
                        <div id="detailsTabContainer" class="detailsTabContainer radius5" runat="server">
                            <ul class="detailslist" runat="server">
                                <li class="detailslist" style="display: none;">
                ...
                <div class="moduleContentCol3">
                	<div class="rightContainer">
                            ...
                            <ContentTemplate>
                                ...
                                <table id="tblSepet" runat="server" border="0" cellpadding="2" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        <td>: <asp:DropDownList ID="ddlSepet" runat="server" DataTextField="CartType" DataValueField="ShoppingCartDefId" Width="96"></asp:DropDownList></td>
                                    </tr>
                                </table>
                        ...
                        <div id="ExtraProduct">
                            <asp:HyperLink ID="hypExtraProduct" runat="server" CssClass="button">Ekstra Ürün Ekle</asp:HyperLink>
                        </div>
                        <div id="receiver" class="receiver" runat="server">
                            <div class="title">Alýcý Bilgileri</div>
                            <div class="receiverLeft">
                                <div>
                                    <asp:Label ID="lblName" runat="server">Alýcýnýn Adý Soyadý</asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:Label ID="Label4" runat="server">Telefon Numarasý :</asp:Label>
                                </div>
                                <div>
                                    <ew:MaskedTextBox ID="txtTel" runat="server" ErrorMessage="geçersiz giriþ" Mask="9999999999" ErrorText="*" MaxLength="10"></ew:MaskedTextBox>
                                ...
                                <div>
                                    <asp:TextBox ID="txtAdres" runat="server" TextMode="MultiLine" MaxLength="50"></asp:TextBox>
                            ...
                            <div class="product-quantity module_box">
                                ...
                                <div id="cart-button">
                                    <asp:Button ID="btnAddToCart2" runat="server" CssClass="addlightbox button" Text="Sepete Ekle" OnClick="btnAddToCart2_Click" />
            ...
            <div class="senderMessage clearFix">
                <div class="col2-1">
                	<div class="title">Gönderen Bilgileri</div>
                    <ul>
                        <li>
                            <asp:DropDownList ID="ddlBillCountry" runat="server"></asp:DropDownList>
                        ...
                        <li>
                            ...
                            <span style="display:none;"><asp:Label ID="lblCity" runat="server"><%=GetGlobalResourceObject("lang", "City")%></asp:Label></span>
                        </li>
                        <li>
                            <span style="display: none;"><asp:Label ID="lblDistrict" runat="server"><%=GetGlobalResourceObject("lang", "District")%></asp:Label></span>
                            <asp:DropDownList ID="ddlDistrict" runat="server"></asp:DropDownList>
                            <cc2:RequiredFieldValidator ID="rfvCity" runat="server" ControlToValidate="ddlCity" ErrorMessage="<%$ Resources:lang, RegisterMsg16%>" InitialValue="">*</cc2:RequiredFieldValidator>
                            <%--<asp:RequiredFieldValidator ID="rfvCity" runat="server" ControlToValidate="ddlCity" ErrorMessage="Þehir Seçiniz..." InitialValue="--Þehir Seçiniz--"></asp:RequiredFieldValidator></td>--%>
                            <cc2:RequiredFieldValidator ID="rvfDistrict" runat="server" ControlToValidate="ddlDistrict" ErrorMessage="ÝlçeSeçiniz..." InitialValue="">*</cc2:RequiredFieldValidator>
                        </li>
                        <li>
                            <%--<asp:RequiredFieldValidator ID="rvfDistrict" runat="server" ControlToValidate="ddlDistrict" ErrorMessage="ÝlçeSeçiniz..." InitialValue="--Ýlçe Seçiniz--"></asp:RequiredFieldValidator>--%>
                            <span style="display: none;"><asp:Label ID="lblCalender" runat="server"><%=GetGlobalResourceObject("lang", "Date1")%></asp:Label></span>
                            <asp:TextBox ID="txtDate" runat="server" Text="Tarih Seciniz..."></asp:TextBox>
                            ...
                            <span style="display:none;"><asp:RequiredFieldValidator ID="rvfDate" runat="server" ControlToValidate="txtDate" ErrorMessage="Tarih Seçiniz..." InitialValue="Tarih Seciniz..."></asp:RequiredFieldValidator></span>
                        </li>
                        <li>
                            <span style="display: none;"><asp:Label ID="lblTime" runat="server"><%=GetGlobalResourceObject("lang", "DeliveryTime")%></asp:Label></span>
                            <asp:DropDownList ID="ddlHour" runat="server"></asp:DropDownList>
                        </li>
                    </ul>
                </div>
                <div class="col2-2 clearFix">
                	<div id="message" runat="server" class="message">
                        <div id="title"><asp:Label ID="lbltitle" CssClass="title" runat="server" Text="KART MESAJI VE KART SEÇÝMÝ" Font-Bold="True" Font-Size="Small"></asp:Label></div>
                        <div class="col2-1 clearFix">
                            <div id="messageInputContainer">
                                <div id="messageName"><label>Karta Yazýlacak Ýsim</label></div>
                                <div id="messageInput"><asp:TextBox ID="txtCartName" runat="server" MaxLength="20"></asp:TextBox></div>
                                <div id="messagecheck"><label><asp:CheckBox ID="chkIsName" runat="server"/> Kartta Ýsmim Görünmesin</label></div>
                                <div id="messageName"><label>Kart Mesajý :</label></div>
                                <div id="messageInput"><asp:TextBox ID="txtCartMesaj" runat="server" TextMode="MultiLine" MaxLength="50"></asp:TextBox></div>
                            </div>
                        </div>
                        <div class="col2-2 clearFix">
                        	<div class="colColor">
...
<script type="text/javascript">
    function checkDate(sender, args) {
        if (new Date().format('yyyy/MM/dd') > sender._selectedDate.format('yyyy/MM/dd')) {
            ...
            alert("Geçmiþ Zaman Seçemezsiniz!");
