                ...
                <ContentTemplate>
                    ...
                    <cc3:CascadingDropDown ID="CascadingDropDown6" runat="server" TargetControlID="ddlShipDistrict"
                        ...
                        <div class="moduleContentCol2 radius5">
                            ...
                            <%  If HttpContext.Current.User.Identity.IsAuthenticated() Then%>
                            <div class="moduleCol1">
                                <label class="labelInput" style="width:auto; float:right; line-height:inherit; margin-right:22px; font-weight:bold;"><%=GetGlobalResourceObject("lang", "SetAsDefault")%>
                                <asp:CheckBox ID="chkBillDefault" runat="server"></asp:CheckBox></label>
                            </div>
                             <% End If%>
                        </div>
                        <div class="moduleContentCol2 radius5">
                        	<label class="title4"><%=GetGlobalResourceObject("lang", "ShippingAddres")%></label>
                            <label class="labelInput"><asp:CheckBox onclick="ShippingChecked();" ID="chkUseBillingOnShipping" runat="server" Checked="true"></asp:CheckBox><%=GetGlobalResourceObject("lang", "UseBillingForShipping")%></label>
