...
<div id="authors" class="module athrs-pblshrs">
    ...
    <div class="moduleContent moduleContentCol1">
        <div class="letter">
            <ul class="clearFix">
                ...
                <li><a href="/store/authors.aspx?l=Ç">Ç</a></li>
                ...
                <li><a href="/store/authors.aspx?l=Ý">Ý</a></li>
        ...
        <div runat="server" id="content" class="content">Yazarlarý filitrelemek için harf seçiniz.</div>
