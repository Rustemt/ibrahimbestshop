...
//
        ...
        <div id="mainPanel" runat="server">
            ...
            <div id="stokalert" visible="false" runat="server" class="alert">
                <asp:Label ID="label333" runat="Server">Seçmiþ olduðunuz ürünlerden bir veya birkaçý stoklarýmýzda tükenmiþ olduðundan dolayý sistem tarafýndan sepetinizden çýkartýlmýþtýr.</asp:Label>
            </div>
            ...
            <div class="dataTable">
                <asp:DataGrid ID="MyList" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyField="Qty" ShowFooter="False" CellPadding="10" CssClass="datalist basketOrder" HeaderStyle-CssClass="title" GridLines="none" ItemStyle-CssClass="row">
                    <Columns>
                        ...
                        <asp:TemplateColumn Visible="False" HeaderText="Ýndirim(KDV)">
                            <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn Visible="False" HeaderText="Ýndirim">
                            <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn Visible="False" HeaderText="Aðýrlýk">
                            <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
            ...
            <div class="orderstep3dLeft">
                        ...
                        <table cellpadding="5" cellspacing="5">
                            <tr>
                                ...
                                <td>:
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtName" ErrorMessage="Lütfen Kart Üzerindeki Ýsimi giriniz.">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>:
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtKKNumber" ErrorMessage="Lütfen Kart Numarasýný giriniz.">*</asp:RequiredFieldValidator>
                            ...
                            <tr>
                                ...
                                <td>:
                                    ...
                                    <asp:RequiredFieldValidator ID="Requiredfieldvalidator1" runat="server" Font-Size="X-Small"
                                        ControlToValidate="ddlMonth" ErrorMessage="Lütfen Son Kullanma Ayýný giriniz."
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Font-Size="X-Small"
                                        ControlToValidate="ddlYear" ErrorMessage="Lütfen Son Kullanma Yýlýný giriniz."
                            ...
                            <tr>
                                ...
                                <td>:
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlKreditBanks"
                                        ErrorMessage="Lütfen Kredi Kartý Bankasýný seçiniz." Font-Size="X-Small" InitialValue="-1">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                ...
                <div class="moduleCol1" style='display: <%= iif(pnlHavaleBanner.visible,"","none") %>'>
                    ...
                    <div id="pnlHavale" runat="server">
                        ...
                        <asp:RequiredFieldValidator ID="rqRegister109" runat="server" ControlToValidate="ddlTrasferBanks" ErrorMessage="Lütfen Havale Yapacaðýnýz Bankayý Seçiniz." Font-Size="X-Small" InitialValue="0">*</asp:RequiredFieldValidator>
                        <label>
                        ...
                        <div id="Div8">
                            <label>
                                ...
                                <span class="iyzicologo">
                                    ...
                                    <asp:Label ID="Label3" runat="server">  &nbsp; Iyzico Ýle Ödeme</asp:Label>
                                </span>
                            </label>
                        </div>
                    </div>
                        ...
                        <div id="Div4">
                            <label>
                                ...
                                <span class="paypallogo">
                                    ...
                                    <asp:Label ID="lblOdemePaypal" runat="server">  &nbsp;  Ýle Ödeme</asp:Label>
                                </span>
                            </label>
                        </div>
                    </div>
                        ...
                        <div id="Div5">
                            <label>
                                ...
                                <span class="payulogo">
                                    ...
                                    <asp:Label ID="lblOdemePayU" runat="server">  &nbsp;  Ýle Ödeme</asp:Label>
                                </span>
                            </label>
                        </div>
                    </div>
                            ...
                            <tr>
                                <td valign="top">
                                    <label class="labelInput">
                                        ...
                                        <asp:CheckBox ID="CheckBox1" onclick="GiftChecked();" runat="server"></asp:CheckBox></label>
                                ...
                                <td valign="top">
                                    <label class="labelInput">
                                        <asp:Label ID="lblPaket" runat="server"><%=GetGlobalResourceObject("lang", "GiftPakage")%></asp:Label>
                                        <asp:CheckBox ID="Checkbox2" onclick="GiftChecked();" runat="server"></asp:CheckBox></label>
                ...
                <div id="stokalert2" visible="false" runat="server" class="title2">
                    <asp:Label ID="label1" runat="Server">Seçmiþ olduðunuz ürünlerden bir veya birkaçý stoklarýmýzda tükenmiþ olduðundan dolayý sistem tarafýndan sepetinizden çýkartýlmýþtýr.</asp:Label>
                </div>
            </div>
            <div class="orderstep3dRight radius5">
                <div class="summaryTitle">Sipariþ Özeti</div>
                <div class="moduleCol13d radius5">
                    ...
                    <div class="moduleCol1 productTotal clearFix">
                        <asp:Label ID="Label7" CssClass="summaryTitle2" runat="server"><%--<%=GetGlobalResourceObject("lang", "TotalToPay")%> :--%>Ürünler Toplamý (KDV Dahil)</asp:Label>
                    ...
                    <div class="moduleCol1 contractContent">
                        <label class="labelInput">
                            ...
                            <span class="contractOne">Sözleþmeleri Kabul Ediyorum</span>
                        ...
                        <asp:CustomValidator ID="valTandCs" runat="server" ErrorMessage="Lütfen sözleþmeyi kabul ediniz." ClientValidationFunction="ValidateCb"> * </asp:CustomValidator>
                    </div>
                    <div class="moduleCol1">
                        <div style="text-align: center">
                            ...
                            <asp:HyperLink runat="server" ID="btnPayIpara" NavigateUrl="javascript:LoadFrame()" CssClass="button">Ýpara Ýle Öde</asp:HyperLink>
                            <asp:HyperLink runat="server" ID="btnPaypal" NavigateUrl="javascript:LoadFrame()" CssClass="button">Paypal Ýle Öde</asp:HyperLink>
                            <asp:HyperLink runat="server" ID="btnPayU" NavigateUrl="javascript:LoadFrame()" CssClass="button">PayU ile Öde</asp:HyperLink>
                            <asp:Button ID="btniyzico" runat="server" Text="Iyzico Ýle Öde" CssClass="button" />
                            ...
                            <asp:Button ID="btnTesan" runat="server" Text="Tesan Ýle Öde" CssClass="button" />
                        </div>
                    </div>
                    <table cellspacing="10" cellpadding="10" border="0" style="float: right; display: none;">
                        ...
                        <tr style="display: none">
                            <td align="right">
                                <asp:Label ID="lblAgirlik" runat="server" Visible="False">Toplam Aðýrlýk :</asp:Label>
                            </td>
                            <td align="right">
                ...
                <div id="pnlContract" runat="server" align="center">
                    <table width="100%" cellspacing="0" cellpadding="4" border="0">
                        <tr>
                            <td>
                                <div id="divcontractform">
                                    <div class="moduleTitle">ÖN BÝLGÝLENDÝRME FORMU</div>
                        ...
                        <tr>
                            <td>
                                <div id="divcontract">
                                    <div class="moduleTitle">MESAFELÝ SATIÞ SÖZLEÞMESÝ</div>
            ...
            <asp:Panel ID="Panel1" Style='display: none;' Width="80%" Height="90%" runat="server" CssClass="modalPopup3d">
                <iframe name="frame3d" id="frame3d" style="height: 100%; width: 100%" src='<%= PostUrl %>'>Tarayýcýnýz sayfa içi çerçeveleri desteklemiyor veya þu anda sayfa içi çerçeveleri
                    göstermek için yapýlandýrýlmamýþ </iframe>
                <div>
            ...
            <script type="text/javascript">
                ...
                GiftChecked();
                $(".lightbox").colorbox({ width: "500", height: "500", iframe: true, scrolling: false });
    ...
    <div id="payment-logos" class="fRight" align="right">
        <img src="<% =getThemePath() %>/images/payment_logos.png" border="0" width="100%" />
    </div>
</div>
