...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="GelirTablosu.ascx.vb" Inherits="ASPNetPortal.CGelirTablosu" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
...
<TABLE id="Table1" class="Global_Modul_Modul" cellSpacing="0" cellPadding="5" width="100%"
	...
	<TR>
		...
		<TD>
			...
			<asp:hyperlink id="showReport" runat="server" Visible="False" CssClass="Global_Normal_Link">Gelir Tablosu Göster</asp:hyperlink></TD>
		<TD></TD>
	</TR>
	<TR>
		<TD></TD>
