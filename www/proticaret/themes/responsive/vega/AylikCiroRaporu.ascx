<%@ Control Language="vb" AutoEventWireup="false" Codebehind="AylikCiroRaporu.ascx.vb" Inherits="ASPNetPortal.AylikCiroRaporu" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
