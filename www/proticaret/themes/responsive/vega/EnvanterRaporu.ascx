<%@ Control Language="vb" AutoEventWireup="false" Codebehind="EnvanterRaporu.ascx.vb" Inherits="ASPNetPortal.EnvanterRaporu" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
