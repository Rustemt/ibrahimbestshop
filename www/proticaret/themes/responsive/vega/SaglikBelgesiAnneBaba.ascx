<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SaglikBelgesiAnneBaba.ascx.vb" Inherits="ASPNetPortal.SaglikBelgesiAnneBaba" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
<%@ Register TagPrefix="uc1" TagName="DesktopModuleTitle" Src="../DesktopModuleTitle.ascx" %>
<P><uc1:desktopmoduletitle id="DesktopModuleTitle1" runat="server"></uc1:desktopmoduletitle><BR>
	<asp:label id="lblMessage" runat="server"></asp:label><asp:dropdownlist id="ddlFirmalar" runat="server" AutoPostBack="True" Width="204px"></asp:dropdownlist><BR>
	<BR>
	<asp:panel id="pnlPer" runat="server">
		<asp:label id="Label1" runat="server">Personel Bilgileri:</asp:label>
...
<asp:panel id="pnlFert" runat="server">
	<TABLE id="tblSecim" height="32" cellSpacing="0" cellPadding="0" width="444" border="1"
		...
		<TR>
			<TD  width="133">
				<asp:Label id="Label5" runat="server">Personel Bilgileri :</asp:Label></TD>
			<TD  align="right" colSpan="5">
				<asp:LinkButton id="btnSelectPer" runat="server" CssClass="Global_Normal_Link">Personel Seç</asp:LinkButton></TD>
		</TR>
		<TR>
			<TD width="133">
	...
	<asp:datagrid id="dgFertler" runat="server" Width="444px" ShowFooter="True" AutoGenerateColumns="False">
		...
		<Columns>
			...
			<asp:HyperLinkColumn Text="GOSTER" Target="_blank" DataNavigateUrlField="IND" DataNavigateUrlFormatString="ViewReport.aspx?report=RpSaglikBelgesiAnneBaba.aspx&amp;Mode=Print&amp;PFIND={0}"
