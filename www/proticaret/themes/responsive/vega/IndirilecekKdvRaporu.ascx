<%@ Control Language="vb" AutoEventWireup="false" Codebehind="IndirilecekKdvRaporu.ascx.vb" Inherits="ASPNetPortal.IndirilecekKdvRaporu" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
