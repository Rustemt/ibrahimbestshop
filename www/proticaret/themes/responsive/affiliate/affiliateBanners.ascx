    ...
    <div class="moduleContent moduleContentCol1"> 
        <div class="dataTable">
            <asp:DataGrid ID="dgbanners" runat="server"  PagerStyle-PrevPageText="Prev"
                ...
                <PagerStyle NextPageText="Next" PrevPageText="Prev" HorizontalAlign="Left" PageButtonCount="15" CssClass="Admin_TabloBaslik dataPager" Mode="NumericPages"></PagerStyle>
            </asp:DataGrid>
        </div>        
