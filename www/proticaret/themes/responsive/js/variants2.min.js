...
function CreateVariants() {
    var a = 0; var b = 0; var c = 0; $(xmldoc).find("variant").each(function () {
        ...
        if ($("#size1SelectorContent button[title=" + $(this).attr("size1").replace(/\//g, "-") .replace(/\//g, "-") + "]").length == 0)
        {
            $("#size1SelectorContent div#sizes1").append('<button rel="variant" type="button" title="' + $(this).attr("size1") + '" id="size1_' + b + '" onmouseover="overVariantSize1(' + b + ');" onmouseout="outVariantSize1(' + b + ');" onclick="setVariantSize1(' + b + ');" class="soldOut" >' + $(this).attr("size1") + "</button>"); b = b + 1
        }
        if ($("#size2SelectorContent button[title=" + $(this).attr("size2") + "]").length == 0)
        { 
            $("#size2SelectorContent div#sizes2").append('<button rel="variant" type="button" title="' + $(this).attr("size2") + '" id="size2_' + c + '" onmouseover="overVariantSize2(' + c + ');" onmouseout="outVariantSize2(' + c + ');" onclick="setVariantSize2(' + c + ');" class="soldOut">' + $(this).attr("size2") + "</button>"); c = c + 1
        }
    })
}
function InitVariants() {
    $(xmldoc).find("variant[qty != '0']").each(function () { $("#size0SelectorContent input[title=" + $(this).attr("size0") + "]").attr("class", "normal"); $("#size1SelectorContent button[title=" + $(this).attr("size1").replace(/\//g, "-")  + "]").attr("class", "normal"); $("#size2SelectorContent button[title=" + $(this).attr("size2") + "]").attr("class", "normal") })
}
function ActiveVariants() {
    $(xmldoc).find("variant[qty != '0']").each(function () { if ($(this).attr("size0") != null) { Size0Active = true; $("#size0SelectorContent").show() } if ($(this).attr("size1").replace(/\//g, "-") .replace(/\//g, "-") != null) { Size1Active = true; $("#size1SelectorContent").show() } if ($(this).attr("size2") != null) { Size2Active = true; $("#size2SelectorContent").show() } return false })
}
