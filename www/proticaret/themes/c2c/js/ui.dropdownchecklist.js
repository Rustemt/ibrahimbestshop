...
// refresh the checked items listing in the display box
 function DisplayMarkCheckedItems(id)
 {   
    var obj = DDCL_GetObject(id);    
 ...
 // refresh the checked items listing in the display box
 function DisplayTypeCheckedItems(id)
 {   
    var obj = DDCL_GetObject(id);    
...
// refresh the checked items listing in the display box
 function DisplayPriceCheckedItems(id)
 {   
    var obj = DDCL_GetObject(id);    
