<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="orderstep3d.ascx.vb" Inherits="ASPNetPortal.orderstep3d" %>
...
//
        ...
        <div id="mainPanel" runat="server">
            ...
            <asp:DataGrid ID="MyList" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyField="Qty" ShowFooter="False" CellPadding="10" CssClass="datalist basketOrder" HeaderStyle-CssClass="title" GridLines="none" ItemStyle-CssClass="row">
                <Columns>
            ...
            <div class="orderstep3dLeft">
                <div class="moduleCol1">
                    ...
                    <div id="pnlKreditCart" runat="server">
                        <div id="posalert" visible="false" runat="server" class="title2">
                            <asp:Label ID="lblPosError" runat="server"></asp:Label></div>
                        <table cellpadding="5" cellspacing="5">
                            <tr>
                                <td>
                                    <asp:Label ID="Label35" runat="server"><%=GetGlobalResourceObject("lang", "CreditCardName")%></asp:Label></td>
                                <td>:
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label36" runat="server"><%=GetGlobalResourceObject("lang", "CreditCardNumber")%></asp:Label></td>
                                <td>:
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label38" runat="server" Width="128px"><%=GetGlobalResourceObject("lang", "CreditCardExDate")%></asp:Label></td>
                                <td>:
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label39" runat="server"><%=GetGlobalResourceObject("lang", "CreditCardSecurityNumber")%></asp:Label></td>
                                <td>:
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label8" runat="server"><%=GetGlobalResourceObject("lang", "SelectBank")%></asp:Label></td>
                                <td>:
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:Label ID="lblBankDetails" runat="server"></asp:Label></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <table border="0" cellpadding="1" cellspacing="0" id="pnlKKOdemeList" runat="server">
                                        <tr>
                                            <td colspan="3">
                                                <asp:Label ID="Label10" runat="server"><%=GetGlobalResourceObject("lang", "CreditCardPaymentOptions")%></asp:Label></td>
                                        </tr>
                                        <tr id="trRbTekcekim" runat="server">
                                            <td>
                                                <cc1:GroupRadioButton ID="rbTekCekim" runat="server" AutoPostBack="True" Checked="True" CommandName="0" CommandArgument="0" GroupName="TaksitSayisi"></cc1:GroupRadioButton></td>
                                            <td>
                                                <asp:Label ID="Label9" runat="server">Tek Çekim</asp:Label></td>
                                            <td>
                                                <asp:Label ID="lblTekCekimTutar" runat="server"></asp:Label></td>
                                        </tr>
                                        <tr id="trRbPuan" runat="server">
                                            <td>
                                                <cc1:GroupRadioButton ID="rbPuan" runat="server" AutoPostBack="True" CommandName="0" CommandArgument="0" GroupName="TaksitSayisi"></cc1:GroupRadioButton></td>
                                            <td>
                                                <asp:Label ID="lblPuan" runat="server">Puan Kullan</asp:Label></td>
                                            <td>
                                                <asp:Label ID="lblPuanTutar" runat="server"></asp:Label></td>
                                        </tr>
                ...
                <div class="moduleCol1" style='display: <%= iif(ConfigurationManager.AppSettings("PaypalActive")="True","","none") %>'>
                    ...
                    <div id="pnlPaypal" runat="server">
                        <label>
                            <asp:Label ID="lblPaypalTransfer" runat="server"></asp:Label></label></div>
                </div>
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    ...
                                    <asp:DataList ID="dlPaket" runat="server" RepeatDirection="Horizontal" RepeatColumns="6" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <p>
                                                <asp:RadioButton onclick="CheckOnes(this);" ID="RadioButton2" runat="server" GroupName="paket"></asp:RadioButton></p>
                ...
                <div id="posalert2" visible="false" runat="server" class="title2">
                    <asp:Label ID="lblPosError2" runat="server"></asp:Label></div>
                <div id="stokalert2" visible="false" runat="server" class="title2">
            ...
            <div class="orderstep3dRight radius5">
                <div class="summaryTitle">Sipariş Özeti</div>
                <div class="moduleCol13d radius5">
                    <div class="moduleCol1 topPrice">
                        <asp:Label ID="lblKargoToplamBedel" CssClass="summaryTitle2" runat="server">KDV Dahil Toplam Tutar</asp:Label>
                        <asp:Label ID="lblKargoDahilToplam" runat="server"></asp:Label>
                    </div>
                    <div class="moduleCol1 orderKdv clearFix">
                    ...
                    <div class="moduleCol1 productTotal clearFix">
                        <asp:Label ID="Label7" CssClass="summaryTitle2" runat="server"><%--<%=GetGlobalResourceObject("lang", "TotalToPay")%> :--%>Ürünler Toplamı (KDV Dahil)</asp:Label>
                        <asp:Label ID="lblKdvDahilToplam" CssClass="priceContent" runat="server"></asp:Label>
                    </div>
                    <div class="moduleCol1 cargoPrice clearFix">
                        <asp:Label ID="lblKargoBedeli" CssClass="summaryTitle2" runat="server"><%=GetGlobalResourceObject("lang", "ShippingPrice")%> :</asp:Label>
                        <asp:Label ID="lblKargoToplam" CssClass="priceContent" runat="server"></asp:Label>
                        <div class="clear"></div>
                    ...
                    <div class="moduleCol1">
                        <asp:Label ID="lblHavale" CssClass="summaryTitle2" runat="server"><%=GetGlobalResourceObject("lang", "TotalWithTransfer")%> :</asp:Label>
                        <asp:Label ID="lblKargoDahilHavale" CssClass="summaryTitle2" runat="server"></asp:Label>
                    </div>
                    <div class="moduleCol1">
                        <asp:Label ID="lblKKTek" CssClass="summaryTitle2" runat="server"><%=GetGlobalResourceObject("lang", "TotalWithCreditCart")%> :</asp:Label>
                        <asp:Label ID="lblKdvDahilKK" CssClass="summaryTitle2" runat="server"></asp:Label>
                    </div>
                    <div class="moduleCol1 contractContent">
                        <label>
                            <asp:CheckBox ID="ChkStp2" runat="server"></asp:CheckBox><%--<%=GetGlobalResourceObject("lang", "ContractCheck")%>--%>
                            <span class="contractOne">Sözleşmeleri Kabul Ediyorum</span>
                            <span class="contractTwo">
                                <a class="lightbox2" href="#contractform1">Ön Bilgilendirme Kosullari' ni ve </a>
                                <a class="lightbox2" href="#contractform2">Mesafeli Satis Sözlesmesi</a>'ni okudum, onayliyorum.
                            </span>

                        </label>
                        <asp:CustomValidator ID="valTandCs" runat="server" ErrorMessage="Lütfen sözleşmeyi kabul ediniz." ClientValidationFunction="ValidateCb"> * </asp:CustomValidator>
                    </div>
                    <div class="moduleCol1">
                    ...
                    <table cellspacing="10" cellpadding="10" border="0" style="float: right; display: none;">
            ...
            <div class="moduleContentCol1 contractform">
                <div id="pnlContract" runat="server" align="center">
                    <table width="100%" cellspacing="0" cellpadding="4" border="0">
                        <tr>
                            <td>
                                <div id="divcontractform">
                                    <div class="moduleTitle">ÖN BİLGİLENDİRME FORMU</div>
                        ...
                        <tr>
                            <td>
                                <div id="divcontract">
                                    <div class="moduleTitle">MESAFELİ SATIŞ SÖZLEŞMESİ</div>
                            ...
                            <td style="display: none;">
                                <label><%=GetGlobalResourceObject("lang", "ContractInfo1")%><a class="lightbox2" href="#contractform1"><%=GetGlobalResourceObject("lang", "ContractInfoClick")%></a></label>
                                <label><%=GetGlobalResourceObject("lang", "ContractInfo2")%><a class="lightbox2" href="#contractform2"><%=GetGlobalResourceObject("lang", "ContractInfoClick")%></a></label>
                            </td>
                        </tr>
                    </table>
                </div>
    ...
    <div id="payment-logos" align="right">
        <img src="<% =getThemePath() %>/images/payment_logos.png" border="0" /></div>
</div>
