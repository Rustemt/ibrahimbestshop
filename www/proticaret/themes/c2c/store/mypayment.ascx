                    ...
                    <asp:DataGrid ID="Datagrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" ShowFooter="True" AllowSorting="True" CssClass="datalist" HeaderStyle-CssClass="title" GridLines="Horizontal" ItemStyle-CssClass="row">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="<%$ Resources:lang,Details %>">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="Server" CssClass="button iButton" NavigateUrl='<%# "Javascript:var PopUpWin = window.open(""/admin/ecommerce/orders/EditPayment.aspx?IND=" & DataBinder.Eval(Container.DataItem,"PaymentId") & "&MID=" & 0 & ""","""",""width=800,height=600,scrollbars=1,toolbar=0,status=1,resizable=1"")" %> '>
