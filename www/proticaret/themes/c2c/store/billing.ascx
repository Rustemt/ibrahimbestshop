    ...
    <div class="moduleContent moduleContentCol1">
        ...
        <div>
            ...
            <div class="moduleContentCol2">
                ...
                <asp:RegularExpressionValidator CssClass="textRed" ID="rgr1" ErrorMessage="T.C. Kimlik No/Vergi No Sadece Rakam Ýçerebilir" ValidationExpression="0123456789" ControlToValidate="taxNo" runat="server" />
