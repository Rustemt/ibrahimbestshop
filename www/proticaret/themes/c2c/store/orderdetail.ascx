    ...
    <div id="module_content">
        ...
        <div>
            <div id="div_print">
            	<div class="dataTable">
                	<table>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td><asp:Label ID="PaymentType" runat="server"></asp:Label></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td align="center">:</td>
                            <td><asp:Label ID="ShipDate" runat="server"></asp:Label></td>
                        </tr>
                    </table>
                </div>
                <div class="dataTable moduleContentCol1">
                ...
                <div class="dataTable moduleContentCol2">
