<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="productfoods.ascx.vb" Inherits="ASPNetPortal.productfoods" %>
...
<div id="foodsProductDetail" class="module">
            ...
            <div id="TblUrunDetayModul" runat="server" class="TblUrunDetayModul">
                ...
                <div class="center">
                	<div id="productName">
                    	...
                    	<asp:Label ID="lblProductCode" CssClass="productCode" runat="server" Visible="false"><b><font color="#000000"><%=GetGlobalResourceObject("lang", "ProductCode")%> :</font> <%= ProductCode %></asp:Label>
                    </div>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <table id="FiyatPanel" cellspacing="0" cellpadding="5" width="100%" border="0">
                                                ...
                                                <% End If%>
                                                <tr class="productPrice" height="20">
                                                    <td align="right" width="180">
                                                       <span>Fiyatı</span></td>
                                                    <td>:</td>
                                                    <td align="left">
                                                        <asp:Label ID="lblMainPrice" CssClass="productPriceOne" runat="server"><%=CurrencySymbolLeft & " " &   formatCurDoviz(MainPrice)& "  " & CurrencySymbolRight%></asp:Label>
                                                    </td>
                                                    <td></td>
                                                </tr>
                                            ...
                                            <div id="variant">
                                                <asp:Repeater ID="rptVaryants" runat="server" OnItemDataBound="rptVaryants_ItemDataBound">
                                                    ...
                                                    <table>
                                                          <tr>
                                                            <td align="left">
                                                                <asp:Label ID="Label4" runat="server"><%=GetGlobalResourceObject("lang", "ChoosePlace")%></asp:Label></td>
                                                            <td>:</td>
                                                            <td align="left">
                                                                <asp:DropDownList ID="ddlPlace" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlQuestion_SelectedIndexChanged"></asp:DropDownList>
                                                                <asp:RequiredFieldValidator ID="rfvPlace" runat="server" ControlToValidate="ddlPlace" InitialValue="--Seçiniz--" ErrorMessage="*" ValidationGroup="addtocart"></asp:RequiredFieldValidator>
                ...
                <div id="right">
                    ...
                    <div class="product-quantity module_box">
                        ...
                        <div id="cart-button">
                            <a id="btnAddToCart2" class="addlightbox cartbutton2 button" onclick="AddToCart()" href="#"><%=GetGlobalResourceObject("lang", "AddToCart")%></a>
                        </div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div id="SatinalPanel" runat="server" class="SatinalPanel">
                        <ul>
                            ...
                            <li style="display:none;"><a href="/store/productdetailsinframe.aspx?id=<%=ProductId%>" class="button minibutton">
                                <img style="border: 0;" src="/uploads/poster/images/see_it_frame.gif" /><%=GetGlobalResourceObject("lang", "ShowInFrame")%></a></li>
                            <% End If%>
                            <li style="display:none;"><a id="lnkCompare" class="lightbox minibutton" href='<%= BaseUrl & "/store/comparepopup.aspx?ProductId=" & Request.Params("ProductId") %>'><%=GetGlobalResourceObject("lang", "AddToCompareProductList")%></a></li>
                            <% If StockQty > 0 Or SellNoneStock Then%>
                            <li style="display:none;"><a id="lnkPricealarm" class="lightbox minibutton" href='<%= BaseUrl & "/store/pricealarmpopup.aspx?ProductId=" & Request.Params("ProductId") %>'><%=GetGlobalResourceObject("lang", "AddToPriceAlarmList")%></a></li>
                            <% Else%>
...
<script type="text/javascript">
    ...
    function AddToCart() {
        ...
        if ($('#tblVariants').length > 0) {
            ...
            attr = attr + $('[id*=ddlPlace] option:selected').val() + ","
            desc = desc + "Servis Yeri:" + $('[id*=ddlPlace] option:selected').text() + ";"
            for (i = 0; i < 50; i++) {
            ...
            $.colorbox({ href: '<%= BaseUrl & "/store/addtocartpopup.aspx?ProductId=" & Request.Params("ProductId") %>&Unit=' + untid + '&ProductSizeId=' + ProductSizeId + '&Qty=' + Qty + '&CartType=' + ctype + '&ValueAdd=' + VariantValue + '&Attributes=' + attr + '&Description=' + desc, width: "600", height: "400", iframe: true, scrolling: false, close: '<%=GetGlobalResourceObject("lang", "close") %>' });
            ...
            //alert('<%= BaseUrl & "/2store/addtocartpopup.aspx?ProductId=" & Request.Params("ProductId") %>&Unit='+ untid + '&ProductSizeId=' + ProductSizeId + '&CartType=' + ctype);  
