...
function fncInputNumericValuesOnly(event) {
    ...
    return true;
        ...
        <div>
            <div class="dataTable">
                <label><%=GetGlobalResourceObject("lang", "SelectBank")%> :
            ...
            <div >
                <table id="Table14" cellspacing="0" cellpadding="3" border="0">
                    ...
                    <tr>
                        <td colspan="2">
                            <div id="posalert" visible="false" runat="server" class="alert"><asp:Label ID="lblPosError" runat="server"></asp:Label></div>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
            ...
            <div id="payment-logos" align="right"><img src="<% =getThemePath() %>/images/payment_logos.png" border="0" /></div>
