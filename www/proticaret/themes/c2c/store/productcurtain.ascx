                            ...
                            <div id="productCurtainPrice">
                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                    ...
                                    <tr>
                                                    ...
                                                    <table id="FiyatPanel" cellspacing="0" cellpadding="0" width="100%" border="0">
                                                        ...
                                                        <tr class="productPrice">
                                                            <td>
                                                                ...
                                                                <span style="display:none;"><asp:Label ID="Label3" runat="server"><%=GetGlobalResourceObject("lang", "PriceMarket")%></asp:Label>
                                     ...
                                     <tr>
                                        <td>
                                            <div><asp:Label runat="server" ID="lblAtte" ></asp:Label></div>
