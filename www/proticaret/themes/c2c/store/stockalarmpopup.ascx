...
<div id="stockalarmpopup" class="module">
    ...
    <div class="moduleContent moduleContentCol1">
        <div id="info" runat="server" class="information title2"><%=GetGlobalResourceObject("lang", "StockAlarmMsg1")%></div>
        <label class="title4"><asp:Label ID="Label2" runat="server"><%=GetGlobalResourceObject("lang", "StockAlarmMsg2")%></asp:Label></label>
