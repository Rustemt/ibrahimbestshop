        ...
        <div class="moduleContentCol2 loginLeft radius5">
            ...
            <div runat="server" id="login_form">
                ...
                <fieldset>
                    ...
                    <label class="moduleContentCol1"><span class="moduleCol1"><asp:CheckBox ID="chkRememberme" runat="server"></asp:CheckBox><%=GetGlobalResourceObject("lang", "RememberMe")%></span></label>
                    ...
                    <label class="moduleContentCol1">
                        <asp:HyperLink CssClass="moduleCol4" ID="lnkRegister" runat="server" NavigateUrl="/register.aspx"><%=GetGlobalResourceObject("lang", "SignUp")%></asp:HyperLink>
