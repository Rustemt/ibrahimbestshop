                                ...
                                <asp:DataList ID="dlGalery" runat="server" DataKeyField="ProductId" Width="100%" EnableViewState="False" RepeatLayout="Flow">
                                    ...
                                    <ItemTemplate>
                                        <div class="productImage">
                                            <a href='<%# string.format(getbaseurl() & "/facebook/product.aspx?ProductId={0}&CatId={1}",container.dataitem("ProductId").tostring,container.dataitem("CatId")) & iif(Request.QueryString.Item("tabId")="","","&tabId=" & Request.QueryString.Item("tabId")) %>'>
                                        ...
                                        <div class="productName">
                                            <asp:HyperLink ID="lnkProductName" runat="server" NavigateUrl='<%# string.format(getbaseurl() & "/facebook/product.aspx?ProductId={0}&CatId={1}",container.dataitem("ProductId").tostring,container.dataitem("CatId")) & iif(Request.QueryString.Item("tabId")="","","&tabId=" & Request.QueryString.Item("tabId")) %>' Text='<%# container.dataitem("ProductName")  %>'>
                                            </asp:HyperLink>
                                        </div>
                                        ...
                                        <div class="productAdd">
                                            <a id="btnAddToCart" class="button" style='display: <%# iif(container.dataitem("StockQty")>0 or container.dataitem("SellNoneStock")="TRUE","","none") %>' href='<%# "https://" & BaseUrl.replace("http://","") & "/facebook/addtocartpopup.aspx?ProductId=" & container.dataitem("ProductId") %>'></a>
                                            <!---->
                                        ...
                                        <div id="homelabels">
                                            <ul class="clearFix">
                                                <li id="FirsatUrunu" style="display: <%# iif(eval("FirsatUrunu"),"block;","none;") %>">Fýrsat</li>
                                                ...
                                                <li id="AyniGunTeslim" style="display: <%# iif(eval("AyniGunTeslim"),"block;","none;") %>">Ayný Gün</li>
                                                <li id="OzelUrun" style="display: <%# iif(eval("OzelUrun"),"block;","none;") %>">Özel</li>
                                                <li id="SinirliSayidaUrun" style="display: <%# iif(eval("SinirliSayidaUrun"),"block;","none;") %>">Sýnýrlý</li>
                                                <li id="YeniUrun" style="display: <%# iif(eval("YeniUrun"),"block;","none;") %>">Yeni</li>
                                                <li id="SokFiyatliUrun" style="display: <%# iif(eval("SokFiyatliUrun"),"block;","none;") %>">Þok</li>
