<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="productcurtain.ascx.vb" Inherits="ASPNetPortal.facebook_productcurtain" %>
                        ...
                        <div id="productCurtainPrice">
                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                ...
                                <tr>
                                    <td>
                                        <div>
                                            <asp:Label runat="server" ID="lblAtte"></asp:Label></div>
