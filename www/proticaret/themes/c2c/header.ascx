<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="header.ascx.vb" Inherits="ASPNetPortal.headerseller" EnableViewState="False" %>
...
<div class="headerTop clearFix">
    <div class="wrapper clearFix">
        <div class="linkLeft clearFix">
            <%If (IsLoggedIn) Then%>
            <span class="welcome"><%=String.Format(GetGlobalResourceObject("lang", "Welcome"), " : " & UserName )%></span>
        ...
        <div id="linkRight" class="linkRight clearFix">
            <div class="linkMenu">
                <ul class="clearFix">
                    ...
                    <%If (IsLoggedIn) Then%>
                    <%If (IsC2C) Then%>
                    <li><a href="/admin/default.aspx?MNID=c2c">Mağaza Yönetimi</a></li>
                    <% End If%>
                    ...
                    <li runat="server" id="lic2c">
                        <a href='<% = iif(ConfigurationManager.AppSettings("UseSsl") = "True", BaseUrl.Replace("http://", "https://"), "")  & "/selleroffice/login.aspx" %>'>Mağaza Girişi</a>
                    </li>
