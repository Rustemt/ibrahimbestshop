...
<!--###########################################
	...
	<xsl:template match="root">
		<html>
			...
			<body>
				<div id="outerWrapper">
				<a href=".">Demonstration</a><span> | </span>
				<a href="?page=settings">Settings</a><span> | </span>
				<a href="?page=logs">Logs</a><span> | </span><a href="?page=host">Host Info</a>
				<a class="more" href="demo" target="_blank">More demos &gt;&gt;</a>
				<xsl:apply-templates/>
				</div>
			</body>
		</html>
...
<!--###########################################
	...
	<xsl:template match="welcome">
		<h1><span class="logo">&lt;easybasket/&gt;</span> Demonstration</h1>
		
		<div style="margin:30px auto 50px auto; width:890px; border:solid 1px #ccc; padding:30px; background:#efefef; height:400px">
			<div class="drag" style="float:left;margin-right:1em;"> 
				<form style="background:#fff;border:1px solid #ccc;padding:1em;width:134px;margin:0;" class="easybasket" method="post" action="?basket=add" data-bubble="Added to Basket">   
					<table> 
						<tr>
							<td style="color:#2D4262 ; font-weight:bold; font-size:14px">Bottle Cap Belt</td>
						</tr>
						<tr>
							<td style="font-size:12px">Price &#163;19.00</td>
						</tr>
						<tr>
							<td>
								<select name="colour">
						...
						<tr> 
							<td> 
								<input type='hidden' name='title' value='Bottle Cap Belt' /> 
								<input type='hidden' name='description' value='0011w346' /> 
								<input type='hidden' name='price' value='19.00' /> 
								<input type='hidden' name='postage' value='1.00' />
								<input type='hidden' name='postage2' value='0.10' />	
								<input style="padding:.5em;width:120px;" type="submit" value="Add To Basket"/> 
							</td> 
						</tr>
					</table> 
				</form> 
			...
			<div class="drag" style="float:left;background:#fff;"> 
				<form style="border:1px solid #ccc;padding:1em;width:134px;margin:0;" class="easybasket" method="post" action="?basket=add">   
					<table> 
						<tr>
							<td style="color:#2D4262 ; font-weight:bold; font-size:14px">Skate Trainers</td>
						</tr>
						<tr>
							<td style="font-size:12px">Price &#163;34.00</td>
						</tr>
						<tr>
							<td>
								<select name="size">
						...
						<tr> 
							<td> 
								<input type='hidden' name='title' value='Skate Board Trainers' /> 
