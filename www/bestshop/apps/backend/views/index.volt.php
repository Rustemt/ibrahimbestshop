...
<head><title>Shopping Dashboard | Dashboard</title>
    ...
    <?php echo $this->tag->stylesheetLink('assets/css/ekle.css'); ?>
    <?php echo $this->tag->stylesheetLink('assets/css/editor.css'); ?>
    <?php echo $this->tag->stylesheetLink('assets/css/urunekle.css'); ?>
</head>
<body>
<div>
...
<?php echo $this->tag->javascriptInclude('assets/odin/js/jquery-1.9.1.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/js/jquery-migrate-1.2.1.min.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/js/jquery-ui.js'); ?>
<!--loading bootstrap js-->
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/bootstrap/js/bootstrap.min.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/bootstrap-hover-dropdown/bootstrap-hover-dropdown.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/js/html5shiv.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/js/respond.min.js'); ?>

<?php echo $this->tag->javascriptInclude('assets/odin/vendors/metisMenu/jquery.metisMenu.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/slimScroll/jquery.slimscroll.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/jquery-cookie/jquery.cookie.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/js/jquery.menu.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/jquery-pace/pace.min.js'); ?>
<!--LOADING SCRIPTS FOR PAGE-->
<!--  <?php echo $this->tag->javascriptInclude('assets/odin/vendors/jquery-knob/jquery.knob.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/jquery-animateNumber/jquery.animateNumber.min.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/flot-chart/jquery.flot.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/flot-chart/jquery.flot.categories.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/flot-chart/jquery.flot.pie.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/flot-chart/jquery.flot.tooltip.js '); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/flot-chart/jquery.flot.resize.js '); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/flot-chart/jquery.flot.fillbetween.js '); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/flot-chart/jquery.flot.stack.js'); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/flot-chart/jquery.flot.spline.js '); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/js/dashboard-shopping.js '); ?> -->
<?php echo $this->tag->javascriptInclude('assets/odin/vendors/bootstrap-switch/js/bootstrap-switch.min.js'); ?>
<!--CORE JAVASCRIPT-->
<?php echo $this->tag->javascriptInclude('assets/odin/js/main.js '); ?>
<?php echo $this->tag->javascriptInclude('assets/odin/js/holder.js '); ?>
